...
model {
  ...
  net_st_ppg ~ normal(b0 + beta_kick_return_avg_PY2 * kick_return_avg_PY2 + beta_kick_return_avg_PY1 * kick_return_avg_PY1 + beta_punt_return_avg_PY2 * punt_return_avg_PY2 + beta_punt_return_avg_PY1 * punt_return_avg_PY1 + beta_fg_rate_PY2 * fg_rate_PY2 + beta_fg_rate_PY1 * fg_rate_PY1 + beta_fg_rate_allowed_PY2 * fg_rate_allowed_PY2 + beta_fg_rate_allowed_PY1 * fg_rate_allowed_PY1 + beta_fg_made_pg_PY2 * fg_made_pg_PY2 + beta_fg_made_pg_PY1 * fg_made_pg_PY1 + beta_fg_made_pg_allowed_PY2 * fg_made_pg_allowed_PY2 + beta_fg_made_pg_allowed_PY1 * fg_made_pg_allowed_PY1 + beta_xpts_pg_PY2 * xpts_pg_PY2 + beta_xpts_pg_PY1 * xpts_pg_PY1 + beta_xpts_pg_allowed_PY2 * xpts_pg_allowed_PY2 + beta_xpts_pg_allowed_PY1 * xpts_pg_allowed_PY1 + beta_kick_return_yds_avg_allowed_PY2 * kick_return_yds_avg_allowed_PY2 + beta_kick_return_yds_avg_allowed_PY1 * kick_return_yds_avg_allowed_PY1 + beta_punt_return_yds_avg_allowed_PY2 * punt_return_yds_avg_allowed_PY2 + beta_punt_return_yds_avg_allowed_PY1 * punt_return_yds_avg_allowed_PY1 + beta_kick_return_avg * kick_return_avg + beta_punt_return_avg * punt_return_avg + beta_fg_rate * fg_rate + beta_fg_rate_allowed * fg_rate_allowed + beta_fg_made_pg * fg_made_pg + beta_fg_made_pg_allowed * fg_made_pg_allowed + beta_xpts_pg * xpts_pg + beta_xpts_allowed_pg * xpts_allowed_pg + beta_kick_return_yds_avg_allowed * kick_return_yds_avg_allowed + beta_punt_return_yds_avg_allowed * punt_return_yds_avg_allowed, sigma);
}

...
model {
  ...
  off_ppg ~ normal(b0 + beta_off_ppa_PY2 * off_ppa_PY2 + beta_off_ppa_PY1 * off_ppa_PY1 + beta_off_ypp_PY2 * off_ypp_PY2 + beta_off_ypp_PY1 * off_ypp_PY1 + beta_off_success_rate_PY2 * off_success_rate_PY2 + beta_off_success_rate_PY1 * off_success_rate_PY1 + beta_off_explosiveness_PY2 * off_explosiveness_PY2 + beta_off_explosiveness_PY1 * off_explosiveness_PY1 + beta_third_conv_rate_PY2 * third_conv_rate_PY2 + beta_third_conv_rate_PY1 * third_conv_rate_PY1 + beta_off_pts_per_opp_PY2 * off_pts_per_opp_PY2 + beta_off_pts_per_opp_PY1 * off_pts_per_opp_PY1 + beta_off_plays_pg * off_plays_pg + beta_off_ppg_aboveavg * off_ppg_aboveavg + beta_VoA_Output * VoA_Output + beta_Conference_Strength * Conference_Strength + beta_off_ppa * off_ppa + beta_off_ypp * off_ypp + beta_off_success_rate * off_success_rate + beta_off_explosiveness * off_explosiveness + beta_third_conv_rate * third_conv_rate + beta_off_pts_per_opp * off_pts_per_opp, sigma);
}

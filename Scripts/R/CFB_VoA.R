...
if (as.numeric(cfb_week) == 0) {
  ...
  CompletedFBSGames_PY3 <- cfbd_game_info(as.numeric(year) - 3) |>
    ...
    filter(
      home_division == "fbs" &
        away_division == "fbs" |
        home_team %in% PY3Teams |
        away_team %in% PY3Teams
    )
  ...
  CompletedFBSGames_PY2 <- cfbd_game_info(as.numeric(year) - 2) |>
    ...
    filter(
      home_division == "fbs" &
        away_division == "fbs" |
        home_team %in% PY2Teams |
        away_team %in% PY2Teams
    )
  ...
  CompletedFBSGames_PY1 <- cfbd_game_info(as.numeric(year) - 1) |>
    ...
    filter(
      home_division == "fbs" &
        away_division == "fbs" |
        home_team %in% PY1Teams |
        away_team %in% PY1Teams
    )
  ...
  PBP_PPA_Adjustment_PY3 <- PBP_PY3_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  PBP_ExpAdjustment_PY3 <- PBP_PY3_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  PBP_YPP_Adjustment_PY3 <- PBP_PY3_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  PBP_PPG_Adjustment_PY3 <- PBP_PY3_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### filtering out columns not used to make opponent-adjusted PPA (EPA) stat
  PBP_PPA_Adjustment_PY2 <- PBP_PY2_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### Extracting just successful plays for opponent-adjusted Explosiveness metric
  PBP_ExpAdjustment_PY2 <- PBP_PY2_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### extracting specific columns for opponent-adjusted yards per play stat
  PBP_YPP_Adjustment_PY2 <- PBP_PY2_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### Extracting PBP for scoring plays
  PBP_PPG_Adjustment_PY2 <- PBP_PY2_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### filtering out columns not used to make opponent-adjusted PPA (EPA) stat
  PBP_PPA_Adjustment_PY1 <- PBP_PY1_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### Extracting just successful plays for opponent-adjusted Explosiveness metric
  PBP_ExpAdjustment_PY1 <- PBP_PY1_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### extracting specific columns for opponent-adjusted yards per play stat
  PBP_YPP_Adjustment_PY1 <- PBP_PY1_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  ### Extracting PBP for scoring plays
  PBP_PPG_Adjustment_PY1 <- PBP_PY1_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  Stats_PY1 <- cfbd_stats_season_team(
  ...
  ## PY2 stats
  Stats_PY2 <- cfbd_stats_season_team(
  ...
  ## PY3 stats
  Stats_PY3 <- cfbd_stats_season_team(
  ...
  ## advanced stats data
  Adv_Stats_PY1 <- cfbd_stats_season_advanced(
    year = as.integer(year) - 1,
  ...
  ## PY2 advanced stats
  Adv_Stats_PY2 <- cfbd_stats_season_advanced(
    year = as.integer(year) - 2,
    excl_garbage_time = FALSE,
    start_week = 1,
    end_week = 15
  ...
  ## PY3 advanced stats
  Adv_Stats_PY3 <- cfbd_stats_season_advanced(
    year = as.integer(year) - 3,
    excl_garbage_time = FALSE,
    start_week = 1,
    end_week = 15
  ...
  ### filtering out columns not used to make opponent-adjusted PPA (EPA) stat
  PBP_PPA_Adjustment <- PBP_Yards[, c(
    "game_id",
    "home",
    "pos_team",
    "def_pos_team",
  ...
  Stats <- cfbd_stats_season_team(
    year = as.integer(year),
    start_week = 1,
    end_week = as.numeric(cfb_week)
  ) |>
    mutate(
      total_yds_pg = total_yds / games,
      pass_yds_pg = net_pass_yds / games,
  ...
  Stats <- cfbd_stats_season_team(
    year = as.integer(year),
    start_week = 1,
    end_week = ifelse(as.numeric(cfb_week) <= 15, as.numeric(cfb_week), 15)
  ) |>
    mutate(
      total_yds_pg = total_yds / games,
      pass_yds_pg = net_pass_yds / games,
...
if (as.numeric(cfb_week) == 0) {
  ...
  colnames(PY3_stats_adv_stats_merge) <- c(
    "season",
    "team",
    "conference",
    "games_PY3",
    ...
    "turnovers_pg_PY3",
    "third_conv_rate_PY3",
    "fourth_conv_rate_PY3",
    "penalty_yds_pg_PY3",
    "yards_per_penalty_PY3",
    "kick_return_avg_PY3",
    "punt_return_avg_PY3",
    "total_yds_pg_PY3",
    "pass_yds_pg_PY3",
    ...
    "first_downs_pg_PY3",
    "off_ypp_PY3",
    "def_interceptions_pg_PY3",
    "off_plays_pg_PY3",
    "off_ppg_PY3",
    "def_ppg_PY3",
    "def_yds_pg_PY3",
    "def_plays_pg_PY3",
    "def_third_conv_rate_PY3",
    "def_fourth_conv_rate_PY3",
    "def_ypp_PY3",
    "fg_rate_PY3",
    "fg_rate_allowed_PY3",
    "fg_made_pg_PY3",
    "fg_made_pg_allowed_PY3",
    "xpts_pg_PY3",
    "xpts_allowed_pg_PY3",
    ...
    "oppoff_ppa_PY3",
    "off_ppa_PY3",
    "off_success_rate_PY3",
    "off_explosiveness_PY3",
    "off_power_success_PY3",
    "off_stuff_rate_PY3",
    "off_line_yds_PY3",
    "off_second_lvl_yds_PY3",
    "off_open_field_yds_PY3",
    "off_pts_per_opp_PY3",
    "off_field_pos_avg_predicted_points_PY3",
    "off_havoc_total_PY3",
    "off_havoc_front_seven_PY3",
    "off_havoc_db_PY3",
    "off_standard_downs_ppa_PY3",
    "off_standard_downs_success_rate_PY3",
    "off_standard_downs_explosiveness_PY3",
    "off_passing_downs_ppa_PY3",
    "off_passing_downs_success_rate_PY3",
    "off_passing_downs_explosiveness_PY3",
    "off_rushing_plays_ppa_PY3",
    "off_rushing_plays_success_rate_PY3",
    "off_rushing_plays_explosiveness_PY3",
    "off_passing_plays_ppa_PY3",
    "off_passing_plays_success_rate_PY3",
    "off_passing_plays_explosiveness_PY3",
    "def_ppa_PY3",
    "def_success_rate_PY3",
    "def_explosiveness_PY3",
    "def_power_success_PY3",
    "def_stuff_rate_PY3",
    "def_line_yds_PY3",
    "def_second_lvl_yds_PY3",
    "def_open_field_yds_PY3",
    "def_pts_per_opp_PY3",
    "def_field_pos_avg_predicted_points_PY3",
    "def_havoc_total_PY3",
    "def_havoc_front_seven_PY3",
    "def_havoc_db_PY3",
    "def_standard_downs_ppa_PY3",
    "def_standard_downs_success_rate_PY3",
    "def_standard_downs_explosiveness_PY3",
    "def_passing_downs_ppa_PY3",
    "def_passing_downs_success_rate_PY3",
    "def_passing_downs_explosiveness_PY3",
    "def_rushing_plays_ppa_PY3",
    "def_rushing_plays_success_rate_PY3",
    "def_rushing_plays_explosiveness_PY3",
    "def_passing_plays_ppa_PY3",
    "def_passing_plays_success_rate_PY3",
    "def_passing_plays_explosiveness_PY3"
  )
  ...
  for (school in 1:nrow(PY3_df)) {
    ...
    PY3_df$off_plays_pg_PY3[school] = nrow(temp_PBP_PY3_yards) /
      PY3_df$games_PY3[school]
    PY3_df$off_ppg_PY3[school] = ((nrow(temp_PBP_PY3_OffTDs) * 6) +
      (nrow(temp_PBP_PY3_2Pts) * 2)) /
      PY3_df$games_PY3[school]
    PY3_df$def_ppg_PY3[school] = ((nrow(temp_PBP_PY3_DefTDs) * 6) +
      (nrow(temp_PBP_PY3_Def2Pts) * 2)) /
      PY3_df$games_PY3[school]
    PY3_df$def_yds_pg_PY3[school] = sum(
      temp_PBP_PY3_Defyards$yards_gained,
      na.rm = TRUE
    ) /
      PY3_df$games_PY3[school]
    PY3_df$def_plays_pg_PY3[school] = nrow(temp_PBP_PY3_Defyards) /
      PY3_df$games_PY3[school]
    PY3_df$def_third_conv_rate_PY3[school] = sum(
      temp_PBP_PY3_3rd$first_by_yards,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY3_3rd)
    PY3_df$def_fourth_conv_rate_PY3[school] = sum(
      temp_PBP_PY3_4th$first_by_yards,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY3_4th)
    PY3_df$def_ypp_PY3[school] = sum(
      temp_PBP_PY3_Defyards$yards_gained,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY3_Defyards)
    PY3_df$fg_rate_PY3[school] = nrow(temp_PBP_PY3_GoodFGs) /
      nrow(temp_PBP_PY3_FGs)
    PY3_df$fg_rate_allowed_PY3[school] = nrow(temp_PBP_PY3_DefGoodFGs) /
      nrow(temp_PBP_PY3_DefFGs)
    PY3_df$fg_made_pg_PY3[school] = nrow(temp_PBP_PY3_GoodFGs) /
      PY3_df$games_PY3[school]
    PY3_df$fg_made_pg_allowed_PY3[school] = nrow(temp_PBP_PY3_DefGoodFGs) /
      PY3_df$games_PY3[school]
    PY3_df$xpts_pg_PY3[school] = nrow(temp_PBP_PY3_XPts) /
      PY3_df$games_PY3[school]
    PY3_df$xpts_allowed_pg_PY3[school] = nrow(temp_PBP_PY3_DefXPts) /
      PY3_df$games_PY3[school]
    PY3_df$kick_return_yds_avg_allowed_PY3[school] = sum(
      temp_PBP_PY3_KickReturn$yards_gained,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY3_KickReturn)
    PY3_df$punt_return_yds_avg_allowed_PY3[school] = sum(
      temp_PBP_PY3_PuntReturn$yards_gained,
      na.rm = TRUE
    )
    PY3_df$st_ppg_PY3[school] = (nrow(temp_PBP_PY3_OffReturnTDs) *
      6 /
      PY3_df$games_PY3[school]) +
      (nrow(temp_PBP_PY3_XPts) / PY3_df$games_PY3[school]) +
      (nrow(temp_PBP_PY3_GoodFGs) / PY3_df$games_PY3[school] * 3)
    PY3_df$st_ppg_allowed_PY3[school] = (nrow(temp_PBP_PY3_ReturnTDs) *
      6 /
      PY3_df$games_PY3[school]) +
      (nrow(temp_PBP_PY3_DefXPts) / PY3_df$games_PY3[school]) +
      (nrow(temp_PBP_PY3_DefGoodFGs) / PY3_df$games_PY3[school] * 3)
    PY3_df$oppdef_ppa_PY3[school] <- mean(
      temp_PBP_PY3_OppDefPPA$ppa,
      na.rm = TRUE
    )
    PY3_df$oppoff_ppa_PY3[school] <- mean(
      temp_PBP_PY3_OppOffPPA$ppa,
      na.rm = TRUE
    )
  }
  ...
  rm(
    temp_PBP_PY3_yards,
    temp_PBP_PY3_Defyards,
    temp_PBP_PY3_3rd,
    temp_PBP_PY3_4th,
    temp_PBP_PY3_OffTDs,
    temp_PBP_PY3_DefTDs,
    temp_PBP_PY3_2Pts,
    temp_PBP_PY3_Def2Pts,
    temp_PBP_PY3_FGs,
    temp_PBP_PY3_GoodFGs,
    temp_PBP_PY3_DefFGs,
    temp_PBP_PY3_DefGoodFGs,
    temp_PBP_PY3_XPts,
    temp_PBP_PY3_DefXPts,
    temp_PBP_PY3_KickReturn,
    temp_PBP_PY3_PuntReturn,
    temp_PBP_PY3_ReturnTDs,
    temp_PBP_PY3_OffReturnTDs,
    temp_PBP_PY3_PuntTDs
  )
  ...
  colnames(PY2_stats_adv_stats_merge) <- c(
    "team",
    "games_PY2",
    "completion_pct_PY2",
    "pass_ypa_PY2",
    ...
    "turnovers_pg_PY2",
    "third_conv_rate_PY2",
    "fourth_conv_rate_PY2",
    "penalty_yds_pg_PY2",
    "yards_per_penalty_PY2",
    "kick_return_avg_PY2",
    "punt_return_avg_PY2",
    "total_yds_pg_PY2",
    "pass_yds_pg_PY2",
    ...
    "xpts_pg_PY2",
    "xpts_allowed_pg_PY2",
    "kick_return_yds_avg_allowed_PY2",
    "punt_return_yds_avg_allowed_PY2",
    "st_ppg_PY2",
    "st_ppg_allowed_PY2",
    "oppdef_ppa_PY2",
    "oppoff_ppa_PY2",
    "off_ppa_PY2",
    "off_success_rate_PY2",
    "off_explosiveness_PY2",
    "off_power_success_PY2",
    "off_stuff_rate_PY2",
    "off_line_yds_PY2",
    "off_second_lvl_yds_PY2",
    "off_open_field_yds_PY2",
    "off_pts_per_opp_PY2",
    "off_field_pos_avg_predicted_points_PY2",
    "off_havoc_total_PY2",
    "off_havoc_front_seven_PY2",
    "off_havoc_db_PY2",
    "off_standard_downs_ppa_PY2",
    "off_standard_downs_success_rate_PY2",
    "off_standard_downs_explosiveness_PY2",
    "off_passing_downs_ppa_PY2",
    "off_passing_downs_success_rate_PY2",
    "off_passing_downs_explosiveness_PY2",
    "off_rushing_plays_ppa_PY2",
    "off_rushing_plays_success_rate_PY2",
    "off_rushing_plays_explosiveness_PY2",
    "off_passing_plays_ppa_PY2",
    "off_passing_plays_success_rate_PY2",
    "off_passing_plays_explosiveness_PY2",
    "def_ppa_PY2",
    "def_success_rate_PY2",
    "def_explosiveness_PY2",
    "def_power_success_PY2",
    "def_stuff_rate_PY2",
    "def_line_yds_PY2",
    "def_second_lvl_yds_PY2",
    "def_open_field_yds_PY2",
    "def_pts_per_opp_PY2",
    "def_field_pos_avg_predicted_points_PY2",
    "def_havoc_total_PY2",
    "def_havoc_front_seven_PY2",
    "def_havoc_db_PY2",
    "def_standard_downs_ppa_PY2",
    "def_standard_downs_success_rate_PY2",
    "def_standard_downs_explosiveness_PY2",
    "def_passing_downs_ppa_PY2",
    "def_passing_downs_success_rate_PY2",
    "def_passing_downs_explosiveness_PY2",
    "def_rushing_plays_ppa_PY2",
    "def_rushing_plays_success_rate_PY2",
    "def_rushing_plays_explosiveness_PY2",
    "def_passing_plays_ppa_PY2",
    "def_passing_plays_success_rate_PY2",
  ...
  for (school in 1:nrow(PY2_df)) {
    ...
    ### using filtered play datasets to calculate variables
    PY2_df$off_plays_pg_PY2[school] = nrow(temp_PBP_PY2_yards) /
      PY2_df$games_PY2[school]
    PY2_df$off_ppg_PY2[school] = ((nrow(temp_PBP_PY2_OffTDs) * 6) +
      (nrow(temp_PBP_PY2_2Pts) * 2)) /
      PY2_df$games_PY2[school]
    PY2_df$def_ppg_PY2[school] = ((nrow(temp_PBP_PY2_DefTDs) * 6) +
      (nrow(temp_PBP_PY2_Def2Pts) * 2)) /
      PY2_df$games_PY2[school]
    PY2_df$def_yds_pg_PY2[school] = sum(
      temp_PBP_PY2_Defyards$yards_gained,
      na.rm = TRUE
    ) /
      PY2_df$games_PY2[school]
    PY2_df$def_plays_pg_PY2[school] = nrow(temp_PBP_PY2_Defyards) /
      PY2_df$games_PY2[school]
    PY2_df$def_third_conv_rate_PY2[school] = sum(
      temp_PBP_PY2_3rd$first_by_yards,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY2_3rd)
    PY2_df$def_fourth_conv_rate_PY2[school] = sum(
      temp_PBP_PY2_4th$first_by_yards,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY2_4th)
    PY2_df$def_ypp_PY2[school] = sum(
      temp_PBP_PY2_Defyards$yards_gained,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY2_Defyards)
    PY2_df$fg_rate_PY2[school] = nrow(temp_PBP_PY2_GoodFGs) /
      nrow(temp_PBP_PY2_FGs)
    PY2_df$fg_rate_allowed_PY2[school] = nrow(temp_PBP_PY2_DefGoodFGs) /
      nrow(temp_PBP_PY2_DefFGs)
    PY2_df$fg_made_pg_PY2[school] = nrow(temp_PBP_PY2_GoodFGs) /
      PY2_df$games_PY2[school]
    PY2_df$fg_made_pg_allowed_PY2[school] = nrow(temp_PBP_PY2_DefGoodFGs) /
      PY2_df$games_PY2[school]
    PY2_df$xpts_pg_PY2[school] = nrow(temp_PBP_PY2_XPts) /
      PY2_df$games_PY2[school]
    PY2_df$xpts_allowed_pg_PY2[school] = nrow(temp_PBP_PY2_DefXPts) /
      PY2_df$games_PY2[school]
    PY2_df$kick_return_yds_avg_allowed_PY2[school] = sum(
      temp_PBP_PY2_KickReturn$yards_gained,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY2_KickReturn)
    PY2_df$punt_return_yds_avg_allowed_PY2[school] = sum(
      temp_PBP_PY2_PuntReturn$yards_gained,
      na.rm = TRUE
    )
    PY2_df$st_ppg_PY2[school] = (nrow(temp_PBP_PY2_OffReturnTDs) *
      6 /
      PY2_df$games_PY2[school]) +
      (nrow(temp_PBP_PY2_XPts) / PY2_df$games_PY2[school]) +
      (nrow(temp_PBP_PY2_GoodFGs) / PY2_df$games_PY2[school] * 3)
    PY2_df$st_ppg_allowed_PY2[school] = (nrow(temp_PBP_PY2_ReturnTDs) *
      6 /
      PY2_df$games_PY2[school]) +
      (nrow(temp_PBP_PY2_DefXPts) / PY2_df$games_PY2[school]) +
      (nrow(temp_PBP_PY2_DefGoodFGs) / PY2_df$games_PY2[school] * 3)
    PY2_df$oppdef_ppa_PY2[school] <- mean(
      temp_PBP_PY2_OppDefPPA$ppa,
      na.rm = TRUE
    )
    PY2_df$oppoff_ppa_PY2[school] <- mean(
      temp_PBP_PY2_OppOffPPA$ppa,
      na.rm = TRUE
    )
  }
  ...
  rm(
    temp_PBP_PY2_yards,
    temp_PBP_PY2_Defyards,
    temp_PBP_PY2_3rd,
    temp_PBP_PY2_4th,
    temp_PBP_PY2_OffTDs,
    temp_PBP_PY2_DefTDs,
    temp_PBP_PY2_2Pts,
    temp_PBP_PY2_Def2Pts,
    temp_PBP_PY2_FGs,
    temp_PBP_PY2_GoodFGs,
    temp_PBP_PY2_DefFGs,
    temp_PBP_PY2_DefGoodFGs,
    temp_PBP_PY2_XPts,
    temp_PBP_PY2_DefXPts,
    temp_PBP_PY2_KickReturn,
    temp_PBP_PY2_PuntReturn,
    temp_PBP_PY2_ReturnTDs,
    temp_PBP_PY2_OffReturnTDs,
    temp_PBP_PY2_PuntTDs,
    temp_PBP_PY2_OppDefPPA,
    temp_PBP_PY2_Offplays
  )
  ...
  colnames(PY1_stats_adv_stats_merge) <- c(
    "team",
    "games_PY1",
    "completion_pct_PY1",
    "pass_ypa_PY1",
    ...
    "turnovers_pg_PY1",
    "third_conv_rate_PY1",
    "fourth_conv_rate_PY1",
    "penalty_yds_pg_PY1",
    "yards_per_penalty_PY1",
    "kick_return_avg_PY1",
    "punt_return_avg_PY1",
    "total_yds_pg_PY1",
    "pass_yds_pg_PY1",
    ...
    "xpts_pg_PY1",
    "xpts_allowed_pg_PY1",
    "kick_return_yds_avg_allowed_PY1",
    "punt_return_yds_avg_allowed_PY1",
    "st_ppg_PY1",
    "st_ppg_allowed_PY1",
    "oppdef_ppa_PY1",
    "oppoff_ppa_PY1",
    "off_ppa_PY1",
    "off_success_rate_PY1",
    "off_explosiveness_PY1",
    "off_power_success_PY1",
    "off_stuff_rate_PY1",
    "off_line_yds_PY1",
    "off_second_lvl_yds_PY1",
    "off_open_field_yds_PY1",
    "off_pts_per_opp_PY1",
    "off_field_pos_avg_predicted_points_PY1",
    "off_havoc_total_PY1",
    "off_havoc_front_seven_PY1",
    "off_havoc_db_PY1",
    "off_standard_downs_ppa_PY1",
    "off_standard_downs_success_rate_PY1",
    "off_standard_downs_explosiveness_PY1",
    "off_passing_downs_ppa_PY1",
    "off_passing_downs_success_rate_PY1",
    "off_passing_downs_explosiveness_PY1",
    "off_rushing_plays_ppa_PY1",
    "off_rushing_plays_success_rate_PY1",
    "off_rushing_plays_explosiveness_PY1",
    "off_passing_plays_ppa_PY1",
    "off_passing_plays_success_rate_PY1",
    "off_passing_plays_explosiveness_PY1",
    "def_ppa_PY1",
    "def_success_rate_PY1",
    "def_explosiveness_PY1",
    "def_power_success_PY1",
    "def_stuff_rate_PY1",
    "def_line_yds_PY1",
    "def_second_lvl_yds_PY1",
    "def_open_field_yds_PY1",
    "def_pts_per_opp_PY1",
    "def_field_pos_avg_predicted_points_PY1",
    "def_havoc_total_PY1",
    "def_havoc_front_seven_PY1",
    "def_havoc_db_PY1",
    "def_standard_downs_ppa_PY1",
    "def_standard_downs_success_rate_PY1",
    "def_standard_downs_explosiveness_PY1",
    "def_passing_downs_ppa_PY1",
    "def_passing_downs_success_rate_PY1",
    "def_passing_downs_explosiveness_PY1",
    "def_rushing_plays_ppa_PY1",
    "def_rushing_plays_success_rate_PY1",
    "def_rushing_plays_explosiveness_PY1",
    "def_passing_plays_ppa_PY1",
    "def_passing_plays_success_rate_PY1",
    "def_passing_plays_explosiveness_PY1"
  )
  ...
  for (school in 1:nrow(PY1_df)) {
    ...
    ### using filtered play datasets to calculate variables
    PY1_df$off_plays_pg_PY1[school] = nrow(temp_PBP_PY1_yards) /
      PY1_df$games_PY1[school]
    PY1_df$off_ppg_PY1[school] = ((nrow(temp_PBP_PY1_OffTDs) * 6) +
      (nrow(temp_PBP_PY1_2Pts) * 2)) /
      PY1_df$games_PY1[school]
    PY1_df$def_ppg_PY1[school] = ((nrow(temp_PBP_PY1_DefTDs) * 6) +
      (nrow(temp_PBP_PY1_Def2Pts) * 2)) /
      PY1_df$games_PY1[school]
    PY1_df$def_yds_pg_PY1[school] = sum(
      temp_PBP_PY1_Defyards$yards_gained,
      na.rm = TRUE
    ) /
      PY1_df$games_PY1[school]
    PY1_df$def_plays_pg_PY1[school] = nrow(temp_PBP_PY1_Defyards) /
      PY1_df$games_PY1[school]
    PY1_df$def_third_conv_rate_PY1[school] = sum(
      temp_PBP_PY1_3rd$first_by_yards,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY1_3rd)
    PY1_df$def_fourth_conv_rate_PY1[school] = sum(
      temp_PBP_PY1_4th$first_by_yards,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY1_4th)
    PY1_df$def_ypp_PY1[school] = sum(
      temp_PBP_PY1_Defyards$yards_gained,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY1_Defyards)
    PY1_df$fg_rate_PY1[school] = nrow(temp_PBP_PY1_GoodFGs) /
      nrow(temp_PBP_PY1_FGs)
    PY1_df$fg_rate_allowed_PY1[school] = nrow(temp_PBP_PY1_DefGoodFGs) /
      nrow(temp_PBP_PY1_DefFGs)
    PY1_df$fg_made_pg_PY1[school] = nrow(temp_PBP_PY1_GoodFGs) /
      PY1_df$games_PY1[school]
    PY1_df$fg_made_pg_allowed_PY1[school] = nrow(temp_PBP_PY1_DefGoodFGs) /
      PY1_df$games_PY1[school]
    PY1_df$xpts_pg_PY1[school] = nrow(temp_PBP_PY1_XPts) /
      PY1_df$games_PY1[school]
    PY1_df$xpts_allowed_pg_PY1[school] = nrow(temp_PBP_PY1_DefXPts) /
      PY1_df$games_PY1[school]
    PY1_df$kick_return_yds_avg_allowed_PY1[school] = sum(
      temp_PBP_PY1_KickReturn$yards_gained,
      na.rm = TRUE
    ) /
      nrow(temp_PBP_PY1_KickReturn)
    PY1_df$punt_return_yds_avg_allowed_PY1[school] = sum(
      temp_PBP_PY1_PuntReturn$yards_gained,
      na.rm = TRUE
    )
    PY1_df$st_ppg_PY1[school] = (nrow(temp_PBP_PY1_OffReturnTDs) *
      6 /
      PY1_df$games_PY1[school]) +
      (nrow(temp_PBP_PY1_XPts) / PY1_df$games_PY1[school]) +
      (nrow(temp_PBP_PY1_GoodFGs) / PY1_df$games_PY1[school] * 3)
    PY1_df$st_ppg_allowed_PY1[school] = (nrow(temp_PBP_PY1_ReturnTDs) *
      6 /
      PY1_df$games_PY1[school]) +
      (nrow(temp_PBP_PY1_DefXPts) / PY1_df$games_PY1[school]) +
      (nrow(temp_PBP_PY1_DefGoodFGs) / PY1_df$games_PY1[school] * 3)
    PY1_df$oppdef_ppa_PY1[school] <- mean(
      temp_PBP_PY1_OppDefPPA$ppa,
      na.rm = TRUE
    )
    PY1_df$oppoff_ppa_PY1[school] <- mean(
      temp_PBP_PY1_OppOffPPA$ppa,
      na.rm = TRUE
    )
  }
  ...
  rm(
    temp_PBP_PY1_yards,
    temp_PBP_PY1_Defyards,
    temp_PBP_PY1_3rd,
    temp_PBP_PY1_4th,
    temp_PBP_PY1_OffTDs,
    temp_PBP_PY1_DefTDs,
    temp_PBP_PY1_2Pts,
    temp_PBP_PY1_Def2Pts,
    temp_PBP_PY1_FGs,
    temp_PBP_PY1_GoodFGs,
    temp_PBP_PY1_DefFGs,
    temp_PBP_PY1_DefGoodFGs,
    temp_PBP_PY1_XPts,
    temp_PBP_PY1_DefXPts,
    temp_PBP_PY1_KickReturn,
    temp_PBP_PY1_PuntReturn,
    temp_PBP_PY1_ReturnTDs,
    temp_PBP_PY1_OffReturnTDs,
    temp_PBP_PY1_PuntTDs,
    temp_PBP_PY1_OppDefPPA,
  ...
  write_csv(
    PY3_df_NoSeasonConf,
    here("Data", paste0("VoA", year), "PYData", "PY3.csv")
  )
...
if (as.numeric(cfb_week) == 0) {
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.7) +
        (adj_off_ppg_PY2 * 0.2) +
        (adj_off_ppg_PY3 * 0.1),
      weighted_def_ppg_mean = (adj_def_ppg_PY1 * 0.7) +
        (adj_def_ppg_PY2 * 0.2) +
        (adj_def_ppg_PY3 * 0.1),
      weighted_net_st_ppg_mean = (net_st_ppg_PY1 * 0.7) +
        (net_st_ppg_PY2 * 0.2) +
        (net_st_ppg_PY3 * 0.1),
      ...
      weighted_off_ppa = (adj_off_ppa_PY3 * 0.1) +
        (adj_off_ppa_PY2 * 0.2) +
        (adj_off_ppa_PY1 * 0.7),
      weighted_off_ypp = (adj_off_ypp_PY3 * 0.1) +
        (adj_off_ypp_PY2 * 0.2) +
        (adj_off_ypp_PY1 * 0.7),
      weighted_off_success_rate = (off_success_rate_PY3 * 0.1) +
        (off_success_rate_PY2 * 0.2) +
        (off_success_rate_PY1 * 0.7),
      weighted_off_explosiveness = (adj_off_explosiveness_PY3 * 0.1) +
        (adj_off_explosiveness_PY2 * 0.2) +
        (adj_off_explosiveness_PY1 * 0.7),
      weighted_third_conv_rate = (third_conv_rate_PY3 * 0.1) +
        (third_conv_rate_PY2 * 0.2) +
        (third_conv_rate_PY1 * 0.7),
      weighted_off_pts_per_opp = (off_pts_per_opp_PY3 * 0.1) +
        (off_pts_per_opp_PY2 * 0.2) +
        (off_pts_per_opp_PY1 * 0.7),
      weighted_off_plays_pg = (off_plays_pg_PY3 * 0.1) +
        (off_plays_pg_PY2 * 0.2) +
        (off_plays_pg_PY1 * 0.7),
      weighted_def_plays_pg = (def_plays_pg_PY3 * 0.1) +
        (def_plays_pg_PY2 * 0.2) +
        (def_plays_pg_PY1 * 0.7),
      weighted_def_ppa = (adj_def_ppa_PY3 * 0.1) +
        (adj_def_ppa_PY2 * 0.2) +
        (adj_def_ppa_PY1 * 0.7),
      weighted_def_ypp = (adj_def_ypp_PY3 * 0.1) +
        (adj_def_ypp_PY2 * 0.2) +
        (adj_def_ypp_PY1 * 0.7),
      weighted_def_success_rate = (def_success_rate_PY3 * 0.1) +
        (def_success_rate_PY2 * 0.2) +
        (def_success_rate_PY1 * 0.7),
      weighted_def_explosiveness = (adj_def_explosiveness_PY3 * 0.1) +
        (adj_def_explosiveness_PY2 * 0.2) +
        (adj_def_explosiveness_PY1 * 0.7),
      weighted_def_third_conv_rate = (def_third_conv_rate_PY3 * 0.1) +
        (def_third_conv_rate_PY2 * 0.2) +
        (def_third_conv_rate_PY1 * 0.7),
      weighted_def_pts_per_opp = (def_pts_per_opp_PY3 * 0.1) +
        (def_pts_per_opp_PY2 * 0.2) +
        (def_pts_per_opp_PY1 * 0.7),
      weighted_def_havoc_total = (def_havoc_total_PY3 * 0.1) +
        (def_havoc_total_PY2 * 0.2) +
        (def_havoc_total_PY1 * 0.7),
      weighted_net_kick_return_avg = ((kick_return_avg_PY3 -
        kick_return_yds_avg_allowed_PY3) *
        0.1) +
        ((kick_return_avg_PY2 - kick_return_yds_avg_allowed_PY2) * 0.2) +
        ((kick_return_avg_PY1 - kick_return_yds_avg_allowed_PY1) * 0.7),
      weighted_net_punt_return_avg = ((punt_return_avg_PY3 -
        punt_return_yds_avg_allowed_PY3) *
        0.1) +
        ((punt_return_avg_PY2 - punt_return_yds_avg_allowed_PY2) * 0.2) +
        ((punt_return_avg_PY1 - punt_return_yds_avg_allowed_PY1) * 0.7),
      weighted_net_fg_rate = ((fg_rate_PY3 - fg_rate_allowed_PY3) * 0.1) +
        ((fg_rate_PY2 - fg_rate_allowed_PY2) * 0.2) +
        ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.7),
      weighted_net_fg_made_pg = ((fg_made_pg_PY3 - fg_made_pg_allowed_PY3) *
        0.1) +
        ((fg_made_pg_PY2 - fg_made_pg_allowed_PY2) * 0.2) +
        ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) * 0.7),
      weighted_net_xpts_pg = ((xpts_pg_PY3 - xpts_allowed_pg_PY3) * 0.1) +
        ((xpts_pg_PY2 - xpts_allowed_pg_PY2) * 0.2) +
        ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.7),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY3 * 0.1) +
        (net_adj_st_ppa_PY2 * 0.2) +
        (net_adj_st_ppa_PY1 * 0.7),
      weighted_mean_oppdef_ppa = ((oppdef_ppa_PY3 * 0.1) +
        (oppdef_ppa_PY2 * 0.2) +
        (oppdef_ppa_PY1 * 0.7)),
      weighted_mean_oppoff_ppa = (oppoff_ppa_PY3 * 0.1) +
        (oppoff_ppa_PY2 * 0.2) +
        (oppoff_ppa_PY1 * 0.7)
    )
} else if (as.numeric(cfb_week) == 1) {
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg * 0.1) +
        (adj_off_ppg_PY1 * 0.7) +
        (adj_off_ppg_PY2 * 0.15) +
        (adj_off_ppg_PY3 * 0.05),
      weighted_def_ppg_mean = (adj_def_ppg * 0.1) +
        (adj_def_ppg_PY1 * 0.7) +
        (adj_def_ppg_PY2 * 0.15) +
        (adj_def_ppg_PY3 * 0.05),
      weighted_net_st_ppg_mean = (net_st_ppg * 0.1) +
        (net_st_ppg_PY1 * 0.7) +
        (net_st_ppg_PY2 * 0.15) +
        (net_st_ppg_PY3 * 0.05),
      off_ppg_aboveavg = weighted_off_ppg_mean - mean(weighted_off_ppg_mean),
      def_ppg_aboveavg = weighted_def_ppg_mean - mean(weighted_def_ppg_mean),
      weighted_off_ppa = (adj_off_ppa_PY3 * 0.05) +
        (adj_off_ppa_PY2 * 0.15) +
        (adj_off_ppa_PY1 * 0.7) +
        (adj_off_ppa * 0.1),
      weighted_off_ypp = (adj_off_ypp_PY3 * 0.05) +
        (adj_off_ypp_PY2 * 0.15) +
        (adj_off_ypp_PY1 * 0.7) +
        (adj_off_ypp * 0.1),
      weighted_off_success_rate = (off_success_rate_PY3 * 0.05) +
        (off_success_rate_PY2 * 0.15) +
        (off_success_rate_PY1 * 0.7) +
        (off_success_rate * 0.1),
      weighted_off_explosiveness = (adj_off_explosiveness_PY3 * 0.05) +
        (adj_off_explosiveness_PY2 * 0.15) +
        (adj_off_explosiveness_PY1 * 0.7) +
        (adj_off_explosiveness * 0.1),
      weighted_third_conv_rate = (third_conv_rate_PY3 * 0.05) +
        (third_conv_rate_PY2 * 0.15) +
        (third_conv_rate_PY1 * 0.7) +
        (third_conv_rate * 0.1),
      weighted_off_pts_per_opp = (off_pts_per_opp_PY3 * 0.05) +
        (off_pts_per_opp_PY2 * 0.15) +
        (off_pts_per_opp_PY1 * 0.7) +
        (off_pts_per_opp * 0.1),
      weighted_off_plays_pg = (off_plays_pg_PY3 * 0.05) +
        (off_plays_pg_PY2 * 0.15) +
        (off_plays_pg_PY1 * 0.7) +
        (off_plays_pg * 0.1),
      weighted_def_plays_pg = (def_plays_pg_PY3 * 0.05) +
        (def_plays_pg_PY2 * 0.15) +
        (def_plays_pg_PY1 * 0.7) +
        (def_plays_pg * 0.1),
      weighted_def_ppa = (adj_def_ppa_PY3 * 0.05) +
        (adj_def_ppa_PY2 * 0.15) +
        (adj_def_ppa_PY1 * 0.7) +
        (adj_def_ppa * 0.1),
      weighted_def_ypp = (adj_def_ypp_PY3 * 0.05) +
        (adj_def_ypp_PY2 * 0.15) +
        (adj_def_ypp_PY1 * 0.7) +
        (adj_def_ypp * 0.1),
      weighted_def_success_rate = (def_success_rate_PY3 * 0.05) +
        (def_success_rate_PY2 * 0.15) +
        (def_success_rate_PY1 * 0.7) +
        (def_success_rate * 0.1),
      weighted_def_explosiveness = (adj_def_explosiveness_PY3 * 0.05) +
        (adj_def_explosiveness_PY2 * 0.15) +
        (adj_def_explosiveness_PY1 * 0.7) +
        (adj_def_explosiveness * 0.1),
      weighted_def_third_conv_rate = (def_third_conv_rate_PY3 * 0.05) +
        (def_third_conv_rate_PY2 * 0.15) +
        (def_third_conv_rate_PY1 * 0.7) +
        (def_third_conv_rate * 0.1),
      weighted_def_pts_per_opp = (def_pts_per_opp_PY3 * 0.05) +
        (def_pts_per_opp_PY2 * 0.15) +
        (def_pts_per_opp_PY1 * 0.7) +
        (def_pts_per_opp * 0.1),
      weighted_def_havoc_total = (def_havoc_total_PY3 * 0.05) +
        (def_havoc_total_PY2 * 0.15) +
        (def_havoc_total_PY1 * 0.7) +
        (def_havoc_total * 0.1),
      weighted_net_kick_return_avg = ((kick_return_avg_PY3 -
        kick_return_yds_avg_allowed_PY3) *
        0.05) +
        ((kick_return_avg_PY2 - kick_return_yds_avg_allowed_PY2) * 0.15) +
        ((kick_return_avg_PY1 - kick_return_yds_avg_allowed_PY1) * 0.7) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.1),
      weighted_net_punt_return_avg = ((punt_return_avg_PY3 -
        punt_return_yds_avg_allowed_PY3) *
        0.05) +
        ((punt_return_avg_PY2 - punt_return_yds_avg_allowed_PY2) * 0.15) +
        ((punt_return_avg_PY1 - punt_return_yds_avg_allowed_PY1) * 0.7) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.1),
      weighted_net_fg_rate = ((fg_rate_PY3 - fg_rate_allowed_PY3) * 0.05) +
        ((fg_rate_PY2 - fg_rate_allowed_PY2) * 0.15) +
        ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.7) +
        ((fg_rate - fg_rate_allowed) * 0.1),
      weighted_net_fg_made_pg = ((fg_made_pg_PY3 - fg_made_pg_allowed_PY3) *
        0.05) +
        ((fg_made_pg_PY2 - fg_made_pg_allowed_PY2) * 0.15) +
        ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) * 0.7) +
        ((fg_made_pg - fg_made_pg_allowed) * 0.1),
      weighted_net_xpts_pg = ((xpts_pg_PY3 - xpts_allowed_pg_PY3) * 0.05) +
        ((xpts_pg_PY2 - xpts_allowed_pg_PY2) * 0.15) +
        ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.7) +
        ((xpts_pg - xpts_allowed_pg) * 0.1),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY3 * 0.05) +
        (net_adj_st_ppa_PY2 * 0.15) +
        (net_adj_st_ppa_PY1 * 0.7) +
        (net_adj_st_ppa * 0.1),
      weighted_mean_oppdef_ppa = (oppdef_ppa_PY3 * 0.05) +
        (oppdef_ppa_PY2 * 0.15) +
        (oppdef_ppa_PY1 * 0.7) +
        (oppdef_ppa * 0.1),
      weighted_mean_oppoff_ppa = (oppoff_ppa_PY3 * 0.05) +
        (oppoff_ppa_PY2 * 0.15) +
        (oppoff_ppa_PY1 * 0.7) +
        (oppoff_ppa * 0.1)
    )
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.5) +
        (adj_off_ppg_PY2 * 0.1) +
        (adj_off_ppg * 0.4),
      weighted_def_ppg_mean = (adj_def_ppg_PY1 * 0.5) +
        (adj_def_ppg_PY2 * 0.1) +
        (adj_def_ppg * 0.4),
      weighted_net_st_ppg_mean = (net_st_ppg_PY1 * 0.5) +
        (net_st_ppg_PY2 * 0.1) +
        (net_st_ppg * 0.4),
      off_ppg_aboveavg = weighted_off_ppg_mean - mean(weighted_off_ppg_mean),
      def_ppg_aboveavg = weighted_def_ppg_mean - mean(weighted_def_ppg_mean),
      weighted_off_ppa = (adj_off_ppa_PY2 * 0.1) +
        (adj_off_ppa_PY1 * 0.5) +
        (adj_off_ppa * 0.4),
      weighted_off_ypp = (adj_off_ypp_PY2 * 0.1) +
        (adj_off_ypp_PY1 * 0.5) +
        (adj_off_ypp * 0.4),
      weighted_off_success_rate = (off_success_rate_PY2 * 0.1) +
        (off_success_rate_PY1 * 0.5) +
        (off_success_rate * 0.4),
      weighted_off_explosiveness = (adj_off_explosiveness_PY2 * 0.1) +
        (adj_off_explosiveness_PY1 * 0.5) +
        (adj_off_explosiveness * 0.4),
      weighted_third_conv_rate = (third_conv_rate_PY2 * 0.1) +
        (third_conv_rate_PY1 * 0.5) +
        (third_conv_rate * 0.4),
      weighted_off_pts_per_opp = (off_pts_per_opp_PY2 * 0.1) +
        (off_pts_per_opp_PY1 * 0.5) +
        (off_pts_per_opp * 0.4),
      weighted_off_plays_pg = (off_plays_pg_PY2 * 0.1) +
        (off_plays_pg_PY1 * 0.5) +
        (off_plays_pg * 0.4),
      weighted_def_plays_pg = (def_plays_pg_PY2 * 0.1) +
        (def_plays_pg_PY1 * 0.5) +
        (def_plays_pg * 0.4),
      weighted_def_ppa = (adj_def_ppa_PY2 * 0.1) +
        (adj_def_ppa_PY1 * 0.5) +
        (adj_def_ppa * 0.4),
      weighted_def_ypp = (adj_def_ypp_PY2 * 0.1) +
        (adj_def_ypp_PY1 * 0.5) +
        (adj_def_ypp * 0.4),
      weighted_def_success_rate = (def_success_rate_PY2 * 0.1) +
        (def_success_rate_PY1 * 0.5) +
        (def_success_rate * 0.4),
      weighted_def_explosiveness = (adj_def_explosiveness_PY2 * 0.1) +
        (adj_def_explosiveness_PY1 * 0.5) +
        (adj_def_explosiveness * 0.4),
      weighted_def_third_conv_rate = (def_third_conv_rate_PY2 * 0.1) +
        (def_third_conv_rate_PY1 * 0.5) +
        (def_third_conv_rate * 0.4),
      weighted_def_pts_per_opp = (def_pts_per_opp_PY2 * 0.1) +
        (def_pts_per_opp_PY1 * 0.5) +
        (def_pts_per_opp * 0.4),
      weighted_def_havoc_total = (def_havoc_total_PY2 * 0.1) +
        (def_havoc_total_PY1 * 0.5) +
        (def_havoc_total * 0.4),
      weighted_net_kick_return_avg = ((kick_return_avg_PY2 -
        kick_return_yds_avg_allowed_PY2) *
        0.1) +
        ((kick_return_avg_PY1 - kick_return_yds_avg_allowed_PY1) * 0.5) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.4),
      weighted_net_punt_return_avg = ((punt_return_avg_PY2 -
        punt_return_yds_avg_allowed_PY2) *
        0.1) +
        ((punt_return_avg_PY1 - punt_return_yds_avg_allowed_PY1) * 0.5) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.4),
      weighted_net_fg_rate = ((fg_rate_PY2 - fg_rate_allowed_PY2) * 0.1) +
        ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.5) +
        ((fg_rate - fg_rate_allowed) * 0.4),
      weighted_net_fg_made_pg = ((fg_made_pg_PY2 - fg_made_pg_allowed_PY2) *
        0.1) +
        ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) * 0.5) +
        ((fg_made_pg - fg_made_pg_allowed) * 0.4),
      weighted_net_xpts_pg = ((xpts_pg_PY2 - xpts_allowed_pg_PY2) * 0.1) +
        ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.5) +
        ((xpts_pg - xpts_allowed_pg) * 0.4),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY2 * 0.1) +
        (net_adj_st_ppa_PY1 * 0.5) +
        (net_adj_st_ppa * 0.4),
      weighted_mean_oppdef_ppa = (oppdef_ppa_PY2 * 0.1) +
        (oppdef_ppa_PY1 * 0.5) +
        (oppdef_ppa * 0.4),
      weighted_mean_oppoff_ppa = (oppoff_ppa_PY2 * 0.1) +
        (oppoff_ppa_PY1 * 0.5) +
        (oppoff_ppa * 0.4)
    )
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.4) +
        (adj_off_ppg_PY2 * 0.1) +
        (adj_off_ppg * 0.5),
      weighted_def_ppg_mean = (adj_def_ppg_PY1 * 0.4) +
        (adj_def_ppg_PY2 * 0.1) +
        (adj_def_ppg * 0.5),
      weighted_net_st_ppg_mean = (net_st_ppg_PY1 * 0.4) +
        (net_st_ppg_PY2 * 0.1) +
        (net_st_ppg * 0.5),
      off_ppg_aboveavg = weighted_off_ppg_mean - mean(weighted_off_ppg_mean),
      def_ppg_aboveavg = weighted_def_ppg_mean - mean(weighted_def_ppg_mean),
      ...
      weighted_off_ypp = (adj_off_ypp_PY2 * 0.1) +
        ...
        (adj_off_ypp * 0.5),
      weighted_off_success_rate = (off_success_rate_PY2 * 0.1) +
        (off_success_rate_PY1 * 0.4) +
        (off_success_rate * 0.5),
      weighted_off_explosiveness = (adj_off_explosiveness_PY2 * 0.1) +
        (adj_off_explosiveness_PY1 * 0.4) +
        (adj_off_explosiveness * 0.5),
      weighted_third_conv_rate = (third_conv_rate_PY2 * 0.1) +
        (third_conv_rate_PY1 * 0.4) +
        (third_conv_rate * 0.5),
      weighted_off_pts_per_opp = (off_pts_per_opp_PY2 * 0.1) +
        (off_pts_per_opp_PY1 * 0.4) +
        (off_pts_per_opp * 0.5),
      weighted_off_plays_pg = (off_plays_pg_PY2 * 0.1) +
        (off_plays_pg_PY1 * 0.4) +
        (off_plays_pg * 0.5),
      weighted_def_plays_pg = (def_plays_pg_PY2 * 0.1) +
        (def_plays_pg_PY1 * 0.4) +
        (def_plays_pg * 0.5),
      weighted_def_ppa = (adj_def_ppa_PY2 * 0.1) +
        (adj_def_ppa_PY1 * 0.4) +
        (adj_def_ppa * 0.5),
      weighted_def_ypp = (adj_def_ypp_PY2 * 0.1) +
        ...
        (adj_def_ypp * 0.5),
      weighted_def_success_rate = (def_success_rate_PY2 * 0.1) +
        (def_success_rate_PY1 * 0.4) +
        (def_success_rate * 0.5),
      weighted_def_explosiveness = (adj_def_explosiveness_PY2 * 0.1) +
        (adj_def_explosiveness_PY1 * 0.4) +
        (adj_def_explosiveness * 0.5),
      weighted_def_third_conv_rate = (def_third_conv_rate_PY2 * 0.1) +
        (def_third_conv_rate_PY1 * 0.4) +
        (def_third_conv_rate * 0.5),
      weighted_def_pts_per_opp = (def_pts_per_opp_PY2 * 0.1) +
        (def_pts_per_opp_PY1 * 0.4) +
        (def_pts_per_opp * 0.5),
      weighted_def_havoc_total = (def_havoc_total_PY2 * 0.1) +
        (def_havoc_total_PY1 * 0.4) +
        (def_havoc_total * 0.5),
      weighted_net_kick_return_avg = ((kick_return_avg_PY2 -
        kick_return_yds_avg_allowed_PY2) *
        0.1) +
        ((kick_return_avg_PY1 - kick_return_yds_avg_allowed_PY1) * 0.4) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.5),
      weighted_net_punt_return_avg = ((punt_return_avg_PY2 -
        punt_return_yds_avg_allowed_PY2) *
        0.1) +
        ((punt_return_avg_PY1 - punt_return_yds_avg_allowed_PY1) * 0.4) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.5),
      weighted_net_fg_rate = ((fg_rate_PY2 - fg_rate_allowed_PY2) * 0.1) +
        ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.4) +
        ((fg_rate - fg_rate_allowed) * 0.5),
      weighted_net_fg_made_pg = ((fg_made_pg_PY2 - fg_made_pg_allowed_PY2) *
        0.1) +
        ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) * 0.4) +
        ((fg_made_pg - fg_made_pg_allowed) * 0.5),
      weighted_net_xpts_pg = ((xpts_pg_PY2 - xpts_allowed_pg_PY2) * 0.1) +
        ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.4) +
        ((xpts_pg - xpts_allowed_pg) * 0.5),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY2 * 0.1) +
        (net_adj_st_ppa_PY1 * 0.4) +
        (net_adj_st_ppa * 0.5),
      weighted_mean_oppdef_ppa = (oppdef_ppa_PY2 * 0.1) +
        (oppdef_ppa_PY1 * 0.4) +
        (oppdef_ppa * 0.5),
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.35) +
        (adj_off_ppg_PY2 * 0.05) +
        (adj_off_ppg * 0.6),
      weighted_def_ppg_mean = (adj_def_ppg_PY1 * 0.35) +
        (adj_def_ppg_PY2 * 0.05) +
        (adj_def_ppg * 0.6),
      weighted_net_st_ppg_mean = (net_st_ppg_PY1 * 0.35) +
        (net_st_ppg_PY2 * 0.05) +
        (net_st_ppg * 0.6),
      off_ppg_aboveavg = weighted_off_ppg_mean - mean(weighted_off_ppg_mean),
      def_ppg_aboveavg = weighted_def_ppg_mean - mean(weighted_def_ppg_mean),
      weighted_off_ppa = (adj_off_ppa_PY2 * 0.05) +
        (adj_off_ppa_PY1 * 0.35) +
        (adj_off_ppa * 0.6),
      weighted_off_ypp = (adj_off_ypp_PY2 * 0.05) +
        (adj_off_ypp_PY1 * 0.35) +
        (adj_off_ypp * 0.6),
      weighted_off_success_rate = (off_success_rate_PY2 * 0.05) +
        (off_success_rate_PY1 * 0.35) +
        (off_success_rate * 0.6),
      weighted_off_explosiveness = (adj_off_explosiveness_PY2 * 0.05) +
        (adj_off_explosiveness_PY1 * 0.35) +
        (adj_off_explosiveness * 0.6),
      weighted_third_conv_rate = (third_conv_rate_PY2 * 0.05) +
        (third_conv_rate_PY1 * 0.35) +
        (third_conv_rate * 0.6),
      weighted_off_pts_per_opp = (off_pts_per_opp_PY2 * 0.05) +
        (off_pts_per_opp_PY1 * 0.35) +
        (off_pts_per_opp * 0.6),
      weighted_off_plays_pg = (off_plays_pg_PY2 * 0.05) +
        (off_plays_pg_PY1 * 0.35) +
        (off_plays_pg * 0.6),
      weighted_def_plays_pg = (def_plays_pg_PY2 * 0.05) +
        (def_plays_pg_PY1 * 0.35) +
        (def_plays_pg * 0.6),
      weighted_def_ppa = (adj_def_ppa_PY2 * 0.05) +
        (adj_def_ppa_PY1 * 0.35) +
        (adj_def_ppa * 0.6),
      weighted_def_ypp = (adj_def_ypp_PY2 * 0.05) +
        (adj_def_ypp_PY1 * 0.35) +
        (adj_def_ypp * 0.6),
      weighted_def_success_rate = (def_success_rate_PY2 * 0.05) +
        (def_success_rate_PY1 * 0.35) +
        (def_success_rate * 0.6),
      weighted_def_explosiveness = (adj_def_explosiveness_PY2 * 0.05) +
        (adj_def_explosiveness_PY1 * 0.35) +
        (adj_def_explosiveness * 0.6),
      weighted_def_third_conv_rate = (def_third_conv_rate_PY2 * 0.05) +
        (def_third_conv_rate_PY1 * 0.35) +
        (def_third_conv_rate * 0.6),
      weighted_def_pts_per_opp = (def_pts_per_opp_PY2 * 0.05) +
        (def_pts_per_opp_PY1 * 0.35) +
        (def_pts_per_opp * 0.6),
      weighted_def_havoc_total = (def_havoc_total_PY2 * 0.05) +
        (def_havoc_total_PY1 * 0.35) +
        (def_havoc_total * 0.6),
      weighted_net_kick_return_avg = ((kick_return_avg_PY2 -
        kick_return_yds_avg_allowed_PY2) *
        0.05) +
        ((kick_return_avg_PY1 - kick_return_yds_avg_allowed_PY1) * 0.35) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.6),
      weighted_net_punt_return_avg = ((punt_return_avg_PY2 -
        punt_return_yds_avg_allowed_PY2) *
        0.05) +
        ((punt_return_avg_PY1 - punt_return_yds_avg_allowed_PY1) * 0.35) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.6),
      weighted_net_fg_rate = ((fg_rate_PY2 - fg_rate_allowed_PY2) * 0.05) +
        ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.35) +
        ((fg_rate - fg_rate_allowed) * 0.6),
      weighted_net_fg_made_pg = ((fg_made_pg_PY2 - fg_made_pg_allowed_PY2) *
        0.05) +
        ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) * 0.35) +
        ((fg_made_pg - fg_made_pg_allowed) * 0.6),
      weighted_net_xpts_pg = ((xpts_pg_PY2 - xpts_allowed_pg_PY2) * 0.05) +
        ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.35) +
        ((xpts_pg - xpts_allowed_pg) * 0.6),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY2 * 0.05) +
        (net_adj_st_ppa_PY1 * 0.35) +
        (net_adj_st_ppa * 0.6),
      weighted_mean_oppdef_ppa = (oppdef_ppa_PY2 * 0.05) +
        (oppdef_ppa_PY1 * 0.35) +
        (oppdef_ppa * 0.6),
      weighted_mean_oppoff_ppa = (oppoff_ppa_PY2 * 0.05) +
        (oppoff_ppa_PY1 * 0.35) +
        (oppoff_ppa * 0.6)
    )
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.3) + (adj_off_ppg * 0.7),
      ...
      weighted_third_conv_rate = (third_conv_rate_PY1 * 0.3) +
        (third_conv_rate * 0.7),
      ...
      weighted_def_pts_per_opp = (def_pts_per_opp_PY1 * 0.3) +
        (def_pts_per_opp * 0.7),
      weighted_def_havoc_total = (def_havoc_total_PY1 * 0.3) +
        (def_havoc_total * 0.7),
      weighted_net_kick_return_avg = ((kick_return_avg_PY1 -
        kick_return_yds_avg_allowed_PY1) *
        0.3) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.7),
      weighted_net_punt_return_avg = ((punt_return_avg_PY1 -
        punt_return_yds_avg_allowed_PY1) *
        0.3) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.7),
      ...
      weighted_net_xpts_pg = ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.3) +
        ((xpts_pg - xpts_allowed_pg) * 0.7),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY1 * 0.3) +
        (net_adj_st_ppa * 0.7),
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.2) + (adj_off_ppg * 0.8),
      ...
      weighted_off_success_rate = (off_success_rate_PY1 * 0.2) +
        (off_success_rate * 0.8),
      weighted_off_explosiveness = (adj_off_explosiveness_PY1 * 0.2) +
        (adj_off_explosiveness * 0.8),
      weighted_third_conv_rate = (third_conv_rate_PY1 * 0.2) +
        (third_conv_rate * 0.8),
      weighted_off_pts_per_opp = (off_pts_per_opp_PY1 * 0.2) +
        (off_pts_per_opp * 0.8),
      ...
      weighted_def_success_rate = (def_success_rate_PY1 * 0.2) +
        (def_success_rate * 0.8),
      weighted_def_explosiveness = (adj_def_explosiveness_PY1 * 0.2) +
        (adj_def_explosiveness * 0.8),
      weighted_def_third_conv_rate = (def_third_conv_rate_PY1 * 0.2) +
        (def_third_conv_rate * 0.8),
      weighted_def_pts_per_opp = (def_pts_per_opp_PY1 * 0.2) +
        (def_pts_per_opp * 0.8),
      weighted_def_havoc_total = (def_havoc_total_PY1 * 0.2) +
        (def_havoc_total * 0.8),
      weighted_net_kick_return_avg = ((kick_return_avg_PY1 -
        kick_return_yds_avg_allowed_PY1) *
        0.2) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.8),
      weighted_net_punt_return_avg = ((punt_return_avg_PY1 -
        punt_return_yds_avg_allowed_PY1) *
        0.2) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.8),
      weighted_net_fg_rate = ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.2) +
        ((fg_rate - fg_rate_allowed) * 0.8),
      weighted_net_fg_made_pg = ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) *
        0.2) +
        ((fg_made_pg - fg_made_pg_allowed) * 0.8),
      weighted_net_xpts_pg = ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.2) +
        ((xpts_pg - xpts_allowed_pg) * 0.8),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY1 * 0.2) +
        (net_adj_st_ppa * 0.8),
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      weighted_off_ppg_mean = (adj_off_ppg_PY1 * 0.1) + (adj_off_ppg * 0.9),
      ...
      weighted_third_conv_rate = (third_conv_rate_PY1 * 0.1) +
        (third_conv_rate * 0.9),
      ...
      weighted_def_pts_per_opp = (def_pts_per_opp_PY1 * 0.1) +
        (def_pts_per_opp * 0.9),
      weighted_def_havoc_total = (def_havoc_total_PY1 * 0.1) +
        (def_havoc_total * 0.9),
      weighted_net_kick_return_avg = ((kick_return_avg_PY1 -
        kick_return_yds_avg_allowed_PY1) *
        0.1) +
        ((kick_return_avg - kick_return_yds_avg_allowed) * 0.9),
      weighted_net_punt_return_avg = ((punt_return_avg_PY1 -
        punt_return_yds_avg_allowed_PY1) *
        0.1) +
        ((punt_return_avg - punt_return_yds_avg_allowed) * 0.9),
      weighted_net_fg_rate = ((fg_rate_PY1 - fg_rate_allowed_PY1) * 0.1) +
        ((fg_rate - fg_rate_allowed) * 0.9),
      weighted_net_fg_made_pg = ((fg_made_pg_PY1 - fg_made_pg_allowed_PY1) *
        0.1) +
        ((fg_made_pg - fg_made_pg_allowed) * 0.9),
      weighted_net_xpts_pg = ((xpts_pg_PY1 - xpts_allowed_pg_PY1) * 0.1) +
        ((xpts_pg - xpts_allowed_pg) * 0.9),
      weighted_net_adj_st_ppa = (net_adj_st_ppa_PY1 * 0.1) +
        (net_adj_st_ppa * 0.9),
...
if (as.numeric(cfb_week) == 0) {
  ...
  PrevWeek_VoA <- read_csv(here(
    "Data",
    paste0("VoA", year),
    paste0(year, week_text, as.numeric(cfb_week) - 1, "_", VoAString)
  ))
  ...
  for (i in 1:nrow(CompletedFBSGames)) {
    ...
    if (CompletedFBSGames$home_team[i] %in% VoA_Variables$team) {
      CompletedFBSGames$home_off_VoA_rating[i] = PrevWeek_VoA$OffVoA_MeanRating[
        PrevWeek_VoA$team == CompletedFBSGames$home_team[i]
      ]
      CompletedFBSGames$home_def_VoA_rating[i] = PrevWeek_VoA$DefVoA_MeanRating[
        PrevWeek_VoA$team == CompletedFBSGames$home_team[i]
      ]
    } else {
    ...
    if (CompletedFBSGames$away_team[i] %in% VoA_Variables$team) {
      CompletedFBSGames$away_off_VoA_rating[i] = PrevWeek_VoA$OffVoA_MeanRating[
        PrevWeek_VoA$team == CompletedFBSGames$away_team[i]
      ]
      CompletedFBSGames$away_def_VoA_rating[i] = PrevWeek_VoA$DefVoA_MeanRating[
        PrevWeek_VoA$team == CompletedFBSGames$away_team[i]
      ]
    } else {
  ...
  for (i in 1:nrow(VoA_Variables)) {
    ...
    VoA_Variables$weighted_off_ppg_mean[i] = temp_off_ppg +
      rnorm(
        1,
    ...
    VoA_Variables$weighted_def_ppg_mean[i] = temp_def_ppg +
      rnorm(
        1,
    ...
    if (VoA_Variables$weighted_off_ppg_mean[i] <= 0) {
      VoA_Variables$weighted_off_ppg_mean[
        i
      ] = abs(VoA_Variables$weighted_off_ppg_mean[i]) + abs(rnorm(1, 5, 1))
    }
    if (VoA_Variables$weighted_def_ppg_mean[i] <= 0) {
      VoA_Variables$weighted_def_ppg_mean[
        i
      ] = abs(VoA_Variables$weighted_def_ppg_mean[i]) + abs(rnorm(1, 5, 1))
    }
  }
} else if (as.numeric(cfb_week) <= 4) {
  ...
  for (i in 1:nrow(VoA_Variables)) {
    ...
    VoA_Variables$weighted_off_ppg_mean[i] = temp_off_ppg +
      rnorm(
        1,
        mean = VoA_Variables$off_error[i] / 2,
        sd = sd(VoA_Variables$off_error)
      )
    temp_def_ppg <- VoA_Variables$weighted_def_ppg_mean[i]
    VoA_Variables$weighted_def_ppg_mean[i] = temp_def_ppg +
      rnorm(
        1,
        mean = VoA_Variables$def_error[i] / 2,
        sd = sd(VoA_Variables$def_error)
      )
...
if (as.numeric(cfb_week) == 0) {
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      ...
      Rank_Off_Field_Pos_Avg_Predicted_Pts_PY3 = dense_rank(desc(
        off_field_pos_avg_predicted_points_PY3
      )),
      ...
      Rank_Off_Standard_Down_PPA_PY3 = dense_rank(desc(
        off_standard_downs_ppa_PY3
      )),
      Rank_Off_Standard_Down_Success_Rt_PY3 = dense_rank(desc(
        off_standard_downs_success_rate_PY3
      )),
      Rank_Off_Standard_Down_Explosiveness_PY3 = dense_rank(desc(
        off_standard_downs_explosiveness_PY3
      )),
      Rank_Off_Pass_Down_PPA_PY3 = dense_rank(desc(off_passing_downs_ppa_PY3)),
      Rank_Off_Pass_Down_Success_Rt_PY3 = dense_rank(desc(
        off_passing_downs_success_rate_PY3
      )),
      Rank_Off_Pass_Down_Explosiveness_PY3 = dense_rank(desc(
        off_passing_downs_explosiveness_PY3
      )),
      Rank_Off_Rush_Play_PPA_PY3 = dense_rank(desc(off_rushing_plays_ppa_PY3)),
      Rank_Off_Rush_Play_Success_Rt_PY3 = dense_rank(desc(
        off_rushing_plays_success_rate_PY3
      )),
      Rank_Off_Rush_Play_Explosiveness_PY3 = dense_rank(desc(
        off_rushing_plays_explosiveness_PY3
      )),
      Rank_Off_Pass_Play_PPA_PY3 = dense_rank(desc(off_passing_plays_ppa_PY3)),
      Rank_Off_Pass_Play_Success_Rt_PY3 = dense_rank(desc(
        off_passing_plays_success_rate_PY3
      )),
      Rank_Off_Pass_Play_Explosiveness_PY3 = dense_rank(desc(
        off_passing_plays_explosiveness_PY3
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts_PY3 = dense_rank(
        def_field_pos_avg_predicted_points_PY3
      ),
      Rank_Def_Havoc_Total_PY3 = dense_rank(desc(def_havoc_total_PY3)),
      Rank_Def_Havoc_Front_Seven_PY3 = dense_rank(desc(
        def_havoc_front_seven_PY3
      )),
      ...
      Rank_Def_Standard_Down_Success_Rt_PY3 = dense_rank(
        def_standard_downs_success_rate_PY3
      ),
      Rank_Def_Standard_Down_Explosiveness_PY3 = dense_rank(
        def_standard_downs_explosiveness_PY3
      ),
      Rank_Def_Pass_Down_PPA_PY3 = dense_rank(def_passing_downs_ppa_PY3),
      Rank_Def_Pass_Down_Success_Rt_PY3 = dense_rank(
        def_passing_downs_success_rate_PY3
      ),
      Rank_Def_Pass_Down_Explosiveness_PY3 = dense_rank(
        def_passing_downs_explosiveness_PY3
      ),
      Rank_Def_Rush_Play_PPA_PY3 = dense_rank(def_rushing_plays_ppa_PY3),
      Rank_Def_Rush_Play_Success_Rt_PY3 = dense_rank(
        def_rushing_plays_success_rate_PY3
      ),
      Rank_Def_Rush_Play_Explosiveness_PY3 = dense_rank(
        def_rushing_plays_explosiveness_PY3
      ),
      Rank_Def_Pass_Play_PPA_PY3 = dense_rank(def_passing_plays_ppa_PY3),
      Rank_Def_Pass_Play_Success_Rt_PY3 = dense_rank(
        def_passing_plays_success_rate_PY3
      ),
      Rank_Def_Pass_Play_Explosiveness_PY3 = dense_rank(
        def_passing_plays_explosiveness_PY3
      ),
      ...
      Rank_Off_Field_Pos_Avg_Predicted_Pts_PY2 = dense_rank(desc(
        off_field_pos_avg_predicted_points_PY2
      )),
      ...
      Rank_Off_Standard_Down_PPA_PY2 = dense_rank(desc(
        off_standard_downs_ppa_PY2
      )),
      Rank_Off_Standard_Down_Success_Rt_PY2 = dense_rank(desc(
        off_standard_downs_success_rate_PY2
      )),
      Rank_Off_Standard_Down_Explosiveness_PY2 = dense_rank(desc(
        off_standard_downs_explosiveness_PY2
      )),
      Rank_Off_Pass_Down_PPA_PY2 = dense_rank(desc(off_passing_downs_ppa_PY2)),
      Rank_Off_Pass_Down_Success_Rt_PY2 = dense_rank(desc(
        off_passing_downs_success_rate_PY2
      )),
      Rank_Off_Pass_Down_Explosiveness_PY2 = dense_rank(desc(
        off_passing_downs_explosiveness_PY2
      )),
      Rank_Off_Rush_Play_PPA_PY2 = dense_rank(desc(off_rushing_plays_ppa_PY2)),
      Rank_Off_Rush_Play_Success_Rt_PY2 = dense_rank(desc(
        off_rushing_plays_success_rate_PY2
      )),
      Rank_Off_Rush_Play_Explosiveness_PY2 = dense_rank(desc(
        off_rushing_plays_explosiveness_PY2
      )),
      Rank_Off_Pass_Play_PPA_PY2 = dense_rank(desc(off_passing_plays_ppa_PY2)),
      Rank_Off_Pass_Play_Success_Rt_PY2 = dense_rank(desc(
        off_passing_plays_success_rate_PY2
      )),
      Rank_Off_Pass_Play_Explosiveness_PY2 = dense_rank(desc(
        off_passing_plays_explosiveness_PY2
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts_PY2 = dense_rank(
        def_field_pos_avg_predicted_points_PY2
      ),
      Rank_Def_Havoc_Total_PY2 = dense_rank(desc(def_havoc_total_PY2)),
      Rank_Def_Havoc_Front_Seven_PY2 = dense_rank(desc(
        def_havoc_front_seven_PY2
      )),
      ...
      Rank_Def_Standard_Down_Success_Rt_PY2 = dense_rank(
        def_standard_downs_success_rate_PY2
      ),
      Rank_Def_Standard_Down_Explosiveness_PY2 = dense_rank(
        def_standard_downs_explosiveness_PY2
      ),
      Rank_Def_Pass_Down_PPA_PY2 = dense_rank(def_passing_downs_ppa_PY2),
      Rank_Def_Pass_Down_Success_Rt_PY2 = dense_rank(
        def_passing_downs_success_rate_PY2
      ),
      Rank_Def_Pass_Down_Explosiveness_PY2 = dense_rank(
        def_passing_downs_explosiveness_PY2
      ),
      Rank_Def_Rush_Play_PPA_PY2 = dense_rank(def_rushing_plays_ppa_PY2),
      Rank_Def_Rush_Play_Success_Rt_PY2 = dense_rank(
        def_rushing_plays_success_rate_PY2
      ),
      Rank_Def_Rush_Play_Explosiveness_PY2 = dense_rank(
        def_rushing_plays_explosiveness_PY2
      ),
      Rank_Def_Pass_Play_PPA_PY2 = dense_rank(def_passing_plays_ppa_PY2),
      Rank_Def_Pass_Play_Success_Rt_PY2 = dense_rank(
        def_passing_plays_success_rate_PY2
      ),
      Rank_Def_Pass_Play_Explosiveness_PY2 = dense_rank(
        def_passing_plays_explosiveness_PY2
      ),
      ...
      Rank_Off_Field_Pos_Avg_Predicted_Pts_PY1 = dense_rank(desc(
        off_field_pos_avg_predicted_points_PY1
      )),
      ...
      Rank_Off_Standard_Down_PPA_PY1 = dense_rank(desc(
        off_standard_downs_ppa_PY1
      )),
      Rank_Off_Standard_Down_Success_Rt_PY1 = dense_rank(desc(
        off_standard_downs_success_rate_PY1
      )),
      Rank_Off_Standard_Down_Explosiveness_PY1 = dense_rank(desc(
        off_standard_downs_explosiveness_PY1
      )),
      Rank_Off_Pass_Down_PPA_PY1 = dense_rank(desc(off_passing_downs_ppa_PY1)),
      Rank_Off_Pass_Down_Success_Rt_PY1 = dense_rank(desc(
        off_passing_downs_success_rate_PY1
      )),
      Rank_Off_Pass_Down_Explosiveness_PY1 = dense_rank(desc(
        off_passing_downs_explosiveness_PY1
      )),
      Rank_Off_Rush_Play_PPA_PY1 = dense_rank(desc(off_rushing_plays_ppa_PY1)),
      Rank_Off_Rush_Play_Success_Rt_PY1 = dense_rank(desc(
        off_rushing_plays_success_rate_PY1
      )),
      Rank_Off_Rush_Play_Explosiveness_PY1 = dense_rank(desc(
        off_rushing_plays_explosiveness_PY1
      )),
      Rank_Off_Pass_Play_PPA_PY1 = dense_rank(desc(off_passing_plays_ppa_PY1)),
      Rank_Off_Pass_Play_Success_Rt_PY1 = dense_rank(desc(
        off_passing_plays_success_rate_PY1
      )),
      Rank_Off_Pass_Play_Explosiveness_PY1 = dense_rank(desc(
        off_passing_plays_explosiveness_PY1
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts_PY1 = dense_rank(
        def_field_pos_avg_predicted_points_PY1
      ),
      Rank_Def_Havoc_Total_PY1 = dense_rank(desc(def_havoc_total_PY1)),
      Rank_Def_Havoc_Front_Seven_PY1 = dense_rank(desc(
        def_havoc_front_seven_PY1
      )),
      ...
      Rank_Def_Standard_Down_Success_Rt_PY1 = dense_rank(
        def_standard_downs_success_rate_PY1
      ),
      Rank_Def_Standard_Down_Explosiveness_PY1 = dense_rank(
        def_standard_downs_explosiveness_PY1
      ),
      Rank_Def_Pass_Down_PPA_PY1 = dense_rank(def_passing_downs_ppa_PY1),
      Rank_Def_Pass_Down_Success_Rt_PY1 = dense_rank(
        def_passing_downs_success_rate_PY1
      ),
      Rank_Def_Pass_Down_Explosiveness_PY1 = dense_rank(
        def_passing_downs_explosiveness_PY1
      ),
      Rank_Def_Rush_Play_PPA_PY1 = dense_rank(def_rushing_plays_ppa_PY1),
      Rank_Def_Rush_Play_Success_Rt_PY1 = dense_rank(
        def_rushing_plays_success_rate_PY1
      ),
      Rank_Def_Rush_Play_Explosiveness_PY1 = dense_rank(
        def_rushing_plays_explosiveness_PY1
      ),
      Rank_Def_Pass_Play_PPA_PY1 = dense_rank(def_passing_plays_ppa_PY1),
      Rank_Def_Pass_Play_Success_Rt_PY1 = dense_rank(
        def_passing_plays_success_rate_PY1
      ),
      Rank_Def_Pass_Play_Explosiveness_PY1 = dense_rank(
        def_passing_plays_explosiveness_PY1
      ),
      ...
      Rank_Off_Second_Lvl_Yds_PY1_col2 = dense_rank(desc(
        off_second_lvl_yds_PY1
      )),
      Rank_Off_Open_Field_Yds_PY1_col2 = dense_rank(desc(
        off_open_field_yds_PY1
      )),
      Rank_Off_Pts_Per_Opp_PY1_col2 = dense_rank(desc(off_pts_per_opp_PY1)),
      Rank_Off_Field_Pos_Avg_Predicted_Pts_PY1_col2 = dense_rank(desc(
        off_field_pos_avg_predicted_points_PY1
      )),
      ...
      Rank_Off_Standard_Down_PPA_PY1_col2 = dense_rank(desc(
        off_standard_downs_ppa_PY1
      )),
      Rank_Off_Standard_Down_Success_Rt_PY1_col2 = dense_rank(desc(
        off_standard_downs_success_rate_PY1
      )),
      Rank_Off_Standard_Down_Explosiveness_PY1_col2 = dense_rank(desc(
        off_standard_downs_explosiveness_PY1
      )),
      Rank_Off_Pass_Down_PPA_PY1_col2 = dense_rank(desc(
        off_passing_downs_ppa_PY1
      )),
      Rank_Off_Pass_Down_Success_Rt_PY1_col2 = dense_rank(desc(
        off_passing_downs_success_rate_PY1
      )),
      Rank_Off_Pass_Down_Explosiveness_PY1_col2 = dense_rank(desc(
        off_passing_downs_explosiveness_PY1
      )),
      Rank_Off_Rush_Play_PPA_PY1_col2 = dense_rank(desc(
        off_rushing_plays_ppa_PY1
      )),
      Rank_Off_Rush_Play_Success_Rt_PY1_col2 = dense_rank(desc(
        off_rushing_plays_success_rate_PY1
      )),
      Rank_Off_Rush_Play_Explosiveness_PY1_col2 = dense_rank(desc(
        off_rushing_plays_explosiveness_PY1
      )),
      Rank_Off_Pass_Play_PPA_PY1_col2 = dense_rank(desc(
        off_passing_plays_ppa_PY1
      )),
      Rank_Off_Pass_Play_Success_Rt_PY1_col2 = dense_rank(desc(
        off_passing_plays_success_rate_PY1
      )),
      Rank_Off_Pass_Play_Explosiveness_PY1_col2 = dense_rank(desc(
        off_passing_plays_explosiveness_PY1
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts_PY1_col2 = dense_rank(
        def_field_pos_avg_predicted_points_PY1
      ),
      Rank_Def_Havoc_Total_PY1_col2 = dense_rank(desc(def_havoc_total_PY1)),
      Rank_Def_Havoc_Front_Seven_PY1_col2 = dense_rank(desc(
        def_havoc_front_seven_PY1
      )),
      Rank_Def_Havoc_DB_PY1_col2 = dense_rank(desc(def_havoc_db_PY1)),
      Rank_Def_Standard_Down_PPA_PY1_col2 = dense_rank(
        def_standard_downs_ppa_PY1
      ),
      Rank_Def_Standard_Down_Success_Rt_PY1_col2 = dense_rank(
        def_standard_downs_success_rate_PY1
      ),
      Rank_Def_Standard_Down_Explosiveness_PY1_col2 = dense_rank(
        def_standard_downs_explosiveness_PY1
      ),
      Rank_Def_Pass_Down_PPA_PY1_col2 = dense_rank(def_passing_downs_ppa_PY1),
      Rank_Def_Pass_Down_Success_Rt_PY1_col2 = dense_rank(
        def_passing_downs_success_rate_PY1
      ),
      Rank_Def_Pass_Down_Explosiveness_PY1_col2 = dense_rank(
        def_passing_downs_explosiveness_PY1
      ),
      Rank_Def_Rush_Play_PPA_PY1_col2 = dense_rank(def_rushing_plays_ppa_PY1),
      Rank_Def_Rush_Play_Success_Rt_PY1_col2 = dense_rank(
        def_rushing_plays_success_rate_PY1
      ),
      Rank_Def_Rush_Play_Explosiveness_PY1_col2 = dense_rank(
        def_rushing_plays_explosiveness_PY1
      ),
      Rank_Def_Pass_Play_PPA_PY1_col2 = dense_rank(def_passing_plays_ppa_PY1),
      Rank_Def_Pass_Play_Success_Rt_PY1_col2 = dense_rank(
        def_passing_plays_success_rate_PY1
      ),
      Rank_Def_Pass_Play_Explosiveness_PY1_col2 = dense_rank(
        def_passing_plays_explosiveness_PY1
      ),
      ...
      Rank_Explosiveness_diff_PY1_col2 = dense_rank(desc(
        Explosiveness_diff_PY1
      )),
      ...
      Rank_Off_Second_Lvl_Yds_PY1_col3 = dense_rank(desc(
        off_second_lvl_yds_PY1
      )),
      Rank_Off_Open_Field_Yds_PY1_col3 = dense_rank(desc(
        off_open_field_yds_PY1
      )),
      Rank_Off_Pts_Per_Opp_PY1_col3 = dense_rank(desc(off_pts_per_opp_PY1)),
      Rank_Off_Field_Pos_Avg_Predicted_Pts_PY1_col3 = dense_rank(desc(
        off_field_pos_avg_predicted_points_PY1
      )),
      ...
      Rank_Off_Standard_Down_PPA_PY1_col3 = dense_rank(desc(
        off_standard_downs_ppa_PY1
      )),
      Rank_Off_Standard_Down_Success_Rt_PY1_col3 = dense_rank(desc(
        off_standard_downs_success_rate_PY1
      )),
      Rank_Off_Standard_Down_Explosiveness_PY1_col3 = dense_rank(desc(
        off_standard_downs_explosiveness_PY1
      )),
      Rank_Off_Pass_Down_PPA_PY1_col3 = dense_rank(desc(
        off_passing_downs_ppa_PY1
      )),
      Rank_Off_Pass_Down_Success_Rt_PY1_col3 = dense_rank(desc(
        off_passing_downs_success_rate_PY1
      )),
      Rank_Off_Pass_Down_Explosiveness_PY1_col3 = dense_rank(desc(
        off_passing_downs_explosiveness_PY1
      )),
      Rank_Off_Rush_Play_PPA_PY1_col3 = dense_rank(desc(
        off_rushing_plays_ppa_PY1
      )),
      Rank_Off_Rush_Play_Success_Rt_PY1_col3 = dense_rank(desc(
        off_rushing_plays_success_rate_PY1
      )),
      Rank_Off_Rush_Play_Explosiveness_PY1_col3 = dense_rank(desc(
        off_rushing_plays_explosiveness_PY1
      )),
      Rank_Off_Pass_Play_PPA_PY1_col3 = dense_rank(desc(
        off_passing_plays_ppa_PY1
      )),
      Rank_Off_Pass_Play_Success_Rt_PY1_col3 = dense_rank(desc(
        off_passing_plays_success_rate_PY1
      )),
      Rank_Off_Pass_Play_Explosiveness_PY1_col3 = dense_rank(desc(
        off_passing_plays_explosiveness_PY1
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts_PY1_col3 = dense_rank(
        def_field_pos_avg_predicted_points_PY1
      ),
      Rank_Def_Havoc_Total_PY1_col3 = dense_rank(desc(def_havoc_total_PY1)),
      Rank_Def_Havoc_Front_Seven_PY1_col3 = dense_rank(desc(
        def_havoc_front_seven_PY1
      )),
      Rank_Def_Havoc_DB_PY1_col3 = dense_rank(desc(def_havoc_db_PY1)),
      Rank_Def_Standard_Down_PPA_PY1_col3 = dense_rank(
        def_standard_downs_ppa_PY1
      ),
      Rank_Def_Standard_Down_Success_Rt_PY1_col3 = dense_rank(
        def_standard_downs_success_rate_PY1
      ),
      Rank_Def_Standard_Down_Explosiveness_PY1_col3 = dense_rank(
        def_standard_downs_explosiveness_PY1
      ),
      Rank_Def_Pass_Down_PPA_PY1_col3 = dense_rank(def_passing_downs_ppa_PY1),
      Rank_Def_Pass_Down_Success_Rt_PY1_col3 = dense_rank(
        def_passing_downs_success_rate_PY1
      ),
      Rank_Def_Pass_Down_Explosiveness_PY1_col3 = dense_rank(
        def_passing_downs_explosiveness_PY1
      ),
      Rank_Def_Rush_Play_PPA_PY1_col3 = dense_rank(def_rushing_plays_ppa_PY1),
      Rank_Def_Rush_Play_Success_Rt_PY1_col3 = dense_rank(
        def_rushing_plays_success_rate_PY1
      ),
      Rank_Def_Rush_Play_Explosiveness_PY1_col3 = dense_rank(
        def_rushing_plays_explosiveness_PY1
      ),
      Rank_Def_Pass_Play_PPA_PY1_col3 = dense_rank(def_passing_plays_ppa_PY1),
      Rank_Def_Pass_Play_Success_Rt_PY1_col3 = dense_rank(
        def_passing_plays_success_rate_PY1
      ),
      Rank_Def_Pass_Play_Explosiveness_PY1_col3 = dense_rank(
        def_passing_plays_explosiveness_PY1
      ),
      ...
      Rank_Explosiveness_diff_PY1_col3 = dense_rank(desc(
        Explosiveness_diff_PY1
      )),
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      ...
      Rank_Off_Second_Lvl_Yds_PY2_col2 = dense_rank(desc(
        off_second_lvl_yds_PY2
      )),
      Rank_Off_Open_Field_Yds_PY2_col2 = dense_rank(desc(
        off_open_field_yds_PY2
      )),
      Rank_Off_Pts_Per_Opp_PY2_col2 = dense_rank(desc(off_pts_per_opp_PY2)),
      Rank_Off_Field_Pos_Avg_Predicted_Pts_PY2_col2 = dense_rank(desc(
        off_field_pos_avg_predicted_points_PY2
      )),
      ...
      Rank_Off_Standard_Down_PPA_PY2_col2 = dense_rank(desc(
        off_standard_downs_ppa_PY2
      )),
      Rank_Off_Standard_Down_Success_Rt_PY2_col2 = dense_rank(desc(
        off_standard_downs_success_rate_PY2
      )),
      Rank_Off_Standard_Down_Explosiveness_PY2_col2 = dense_rank(desc(
        off_standard_downs_explosiveness_PY2
      )),
      Rank_Off_Pass_Down_PPA_PY2_col2 = dense_rank(desc(
        off_passing_downs_ppa_PY2
      )),
      Rank_Off_Pass_Down_Success_Rt_PY2_col2 = dense_rank(desc(
        off_passing_downs_success_rate_PY2
      )),
      Rank_Off_Pass_Down_Explosiveness_PY2_col2 = dense_rank(desc(
        off_passing_downs_explosiveness_PY2
      )),
      Rank_Off_Rush_Play_PPA_PY2_col2 = dense_rank(desc(
        off_rushing_plays_ppa_PY2
      )),
      Rank_Off_Rush_Play_Success_Rt_PY2_col2 = dense_rank(desc(
        off_rushing_plays_success_rate_PY2
      )),
      Rank_Off_Rush_Play_Explosiveness_PY2_col2 = dense_rank(desc(
        off_rushing_plays_explosiveness_PY2
      )),
      Rank_Off_Pass_Play_PPA_PY2_col2 = dense_rank(desc(
        off_passing_plays_ppa_PY2
      )),
      Rank_Off_Pass_Play_Success_Rt_PY2_col2 = dense_rank(desc(
        off_passing_plays_success_rate_PY2
      )),
      Rank_Off_Pass_Play_Explosiveness_PY2_col2 = dense_rank(desc(
        off_passing_plays_explosiveness_PY2
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts_PY2_col2 = dense_rank(
        def_field_pos_avg_predicted_points_PY2
      ),
      Rank_Def_Havoc_Total_PY2_col2 = dense_rank(desc(def_havoc_total_PY2)),
      Rank_Def_Havoc_Front_Seven_PY2_col2 = dense_rank(desc(
        def_havoc_front_seven_PY2
      )),
      Rank_Def_Havoc_DB_PY2_col2 = dense_rank(desc(def_havoc_db_PY2)),
      Rank_Def_Standard_Down_PPA_PY2_col2 = dense_rank(
        def_standard_downs_ppa_PY2
      ),
      Rank_Def_Standard_Down_Success_Rt_PY2_col2 = dense_rank(
        def_standard_downs_success_rate_PY2
      ),
      Rank_Def_Standard_Down_Explosiveness_PY2_col2 = dense_rank(
        def_standard_downs_explosiveness_PY2
      ),
      Rank_Def_Pass_Down_PPA_PY2_col2 = dense_rank(def_passing_downs_ppa_PY2),
      Rank_Def_Pass_Down_Success_Rt_PY2_col2 = dense_rank(
        def_passing_downs_success_rate_PY2
      ),
      Rank_Def_Pass_Down_Explosiveness_PY2_col2 = dense_rank(
        def_passing_downs_explosiveness_PY2
      ),
      Rank_Def_Rush_Play_PPA_PY2_col2 = dense_rank(def_rushing_plays_ppa_PY2),
      Rank_Def_Rush_Play_Success_Rt_PY2_col2 = dense_rank(
        def_rushing_plays_success_rate_PY2
      ),
      Rank_Def_Rush_Play_Explosiveness_PY2_col2 = dense_rank(
        def_rushing_plays_explosiveness_PY2
      ),
      Rank_Def_Pass_Play_PPA_PY2_col2 = dense_rank(def_passing_plays_ppa_PY2),
      Rank_Def_Pass_Play_Success_Rt_PY2_col2 = dense_rank(
        def_passing_plays_success_rate_PY2
      ),
      Rank_Def_Pass_Play_Explosiveness_PY2_col2 = dense_rank(
        def_passing_plays_explosiveness_PY2
      ),
      ...
      Rank_Explosiveness_diff_PY2_col2 = dense_rank(desc(
        Explosiveness_diff_PY2
      )),
      Rank_Recruit_Pts_PY2_col2 = dense_rank(desc(recruit_pts_PY2)),
      ### PY1 ranks
      Rank_Comp_Pct_PY1 = dense_rank(desc(completion_pct_PY1)),
      ...
      Rank_Off_Field_Pos_Avg_Predicted_Pts = dense_rank(desc(
        off_field_pos_avg_predicted_points
      )),
      ...
      Rank_Off_Rush_Play_Success_Rt = dense_rank(desc(
        off_rushing_plays_success_rate
      )),
      ...
      Rank_Off_Pass_Play_Success_Rt = dense_rank(desc(
        off_passing_plays_success_rate
      )),
      ...
      Rank_Def_Field_Pos_Avg_Predicted_Pts = dense_rank(
        def_field_pos_avg_predicted_points
      ),
      ...
      Rank_Def_Rush_Play_Success_Rt = dense_rank(
        def_rushing_plays_success_rate
      ),
      ...
      Rank_Def_Pass_Play_Success_Rt = dense_rank(
        def_passing_plays_success_rate
      ),
      ...
      Rank_Off_Standard_Down_PPA_col2 = dense_rank(desc(
        off_standard_downs_ppa
      )),
      ...
      Rank_Def_Rush_Play_Success_Rt_col2 = dense_rank(
        def_rushing_plays_success_rate
      ),
  ...
  VoA_Variables <- VoA_Variables |>
    mutate(
      ...
      Rank_Off_Pts_Per_Opp_col2 = dense_rank(desc(off_pts_per_opp)),
      Rank_Off_Field_Pos_Avg_Predicted_Pts_col2 = dense_rank(desc(
        off_field_pos_avg_predicted_points
      )),
      Rank_Off_Havoc_Total_col2 = dense_rank(off_havoc_total),
      Rank_Off_Havoc_Front_col2 = dense_rank(off_havoc_front_seven),
      ...
      Rank_Def_Pts_Per_Opp_col2 = dense_rank(def_pts_per_opp),
      Rank_Def_Field_Pos_Avg_Predicted_Pts_col2 = dense_rank(
        def_field_pos_avg_predicted_points
      ),
      Rank_Def_Havoc_Total_col2 = dense_rank(desc(def_havoc_total)),
      Rank_Def_Havoc_Front_Seven_col2 = dense_rank(desc(def_havoc_front_seven)),
      ...
      Rank_Off_Standard_Down_PPA_col3 = dense_rank(desc(
        off_standard_downs_ppa
      )),
      Rank_Off_Standard_Down_Success_Rt_col3 = dense_rank(desc(
        off_standard_downs_success_rate
      )),
      Rank_Off_Standard_Down_Explosiveness_col3 = dense_rank(desc(
        off_standard_downs_explosiveness
      )),
      Rank_Off_Pass_Down_PPA_col3 = dense_rank(desc(off_passing_downs_ppa)),
      Rank_Off_Pass_Down_Success_Rt_col3 = dense_rank(desc(
        off_passing_downs_success_rate
      )),
      Rank_Off_Pass_Down_Explosiveness_col3 = dense_rank(desc(
        off_passing_downs_explosiveness
      )),
      Rank_Off_Rush_Play_PPA_col3 = dense_rank(desc(off_rushing_plays_ppa)),
      Rank_Off_Rush_Play_Success_Rt_col3 = dense_rank(desc(
        off_rushing_plays_success_rate
      )),
      Rank_Off_Rush_Play_Explosiveness_col3 = dense_rank(desc(
        off_rushing_plays_explosiveness
      )),
      Rank_Off_Pass_Play_PPA_col3 = dense_rank(desc(off_passing_plays_ppa)),
      Rank_Off_Pass_Play_Success_Rt_col3 = dense_rank(desc(
        off_passing_plays_success_rate
      )),
      Rank_Off_Pass_Play_Explosiveness_col3 = dense_rank(desc(
        off_passing_plays_explosiveness
      )),
      ...
      Rank_Def_Standard_Down_Success_Rt_col3 = dense_rank(
        def_standard_downs_success_rate
      ),
      Rank_Def_Standard_Down_Explosiveness_col3 = dense_rank(
        def_standard_downs_explosiveness
      ),
      Rank_Def_Pass_Down_PPA_col3 = dense_rank(def_passing_downs_ppa),
      Rank_Def_Pass_Down_Success_Rt_col3 = dense_rank(
        def_passing_downs_success_rate
      ),
      Rank_Def_Pass_Down_Explosiveness_col3 = dense_rank(
        def_passing_downs_explosiveness
      ),
      Rank_Def_Rush_Play_PPA_col3 = dense_rank(def_rushing_plays_ppa),
      Rank_Def_Rush_Play_Success_Rt_col3 = dense_rank(
        def_rushing_plays_success_rate
      ),
      Rank_Def_Rush_Play_Explosiveness_col3 = dense_rank(
        def_rushing_plays_explosiveness
      ),
      Rank_Def_Pass_Play_PPA_col3 = dense_rank(def_passing_plays_ppa),
      Rank_Def_Pass_Play_Success_Rt_col3 = dense_rank(
        def_passing_plays_success_rate
      ),
      Rank_Def_Pass_Play_Explosiveness_col3 = dense_rank(
        def_passing_plays_explosiveness
      ),
...
if (as.numeric(cfb_week) <= 8) {
  ...
  Off_VoA_datalist <- list(
    ...
    off_ppg = VoA_Variables$weighted_off_ppg_mean,
    off_ppa = VoA_Variables$weighted_off_ppa,
    off_ypp = VoA_Variables$weighted_off_ypp,
    off_success_rate = VoA_Variables$weighted_off_success_rate,
    off_explosiveness = VoA_Variables$weighted_off_explosiveness,
    third_conv_rate = VoA_Variables$weighted_third_conv_rate,
      ...
      Off_VoA_Rating <- rnorm(
        ...
        mean = Off_VoA_pars$b0[p] +
          ...
          Off_VoA_pars$beta_Conference_Strength[p] *
            (1 / VoA_Variables$Conference_Strength[t]),
  ...
  Def_VoA_datalist <- list(
    N = nrow(VoA_Variables),
    def_ppg = VoA_Variables$weighted_def_ppg_mean,
    def_ppa = VoA_Variables$weighted_def_ppa,
    def_ypp = VoA_Variables$weighted_def_ypp,
    def_success_rate = VoA_Variables$weighted_def_success_rate,
    ...
    def_havoc_total = VoA_Variables$weighted_def_havoc_total,
    ...
    for (t in 1:nrow(VoA_Variables)) {
      Def_VoA_Rating <- rnorm(
        ...
        mean = Def_VoA_pars$b0[p] +
          Def_VoA_pars$beta_def_ppa[p] * VoA_Variables$weighted_def_ppa[t] +
          Def_VoA_pars$beta_def_ypp[p] * VoA_Variables$weighted_def_ypp[t] +
          Def_VoA_pars$beta_def_success_rate[p] *
            VoA_Variables$weighted_def_success_rate[t] +
          ...
          Def_VoA_pars$beta_def_havoc_total[p] *
            VoA_Variables$weighted_def_havoc_total[t] +
          ...
          Def_VoA_pars$beta_Conference_Strength[p] *
            VoA_Variables$Conference_Strength[t],
  ...
  ST_VoA_datalist <- list(
    N = nrow(VoA_Variables),
    net_st_ppg = VoA_Variables$weighted_net_st_ppg_mean,
    net_kick_return_avg = VoA_Variables$weighted_net_kick_return_avg,
    net_punt_return_avg = VoA_Variables$weighted_net_punt_return_avg,
  ...
  Off_VoA_datalist <- list(
    ...
    off_ppa = VoA_Variables$adj_off_ppa,
    off_ypp = VoA_Variables$adj_off_ypp,
    off_success_rate = VoA_Variables$off_success_rate,
    off_explosiveness = VoA_Variables$adj_off_explosiveness,
    third_conv_rate = VoA_Variables$third_conv_rate,
  ...
  for (p in 1:length(Off_VoA_pars$b0)) {
    for (t in 1:nrow(VoA_Variables)) {
      Off_VoA_Rating <- rnorm(
        1,
        mean = Off_VoA_pars$b0[p] +
          Off_VoA_pars$beta_off_ppa[p] * VoA_Variables$adj_off_ppa[t] +
          Off_VoA_pars$beta_off_ypp[p] * VoA_Variables$adj_off_ypp[t] +
          Off_VoA_pars$beta_off_success_rate[p] *
            VoA_Variables$off_success_rate[t] +
          Off_VoA_pars$beta_off_explosiveness[p] *
            VoA_Variables$adj_off_explosiveness[t] +
          Off_VoA_pars$beta_third_conv_rate[p] *
            VoA_Variables$third_conv_rate[t] +
          Off_VoA_pars$beta_off_pts_per_opp[p] *
  ...
  Def_VoA_datalist <- list(
    ...
    def_ppa = VoA_Variables$adj_def_ppa,
    def_ypp = VoA_Variables$adj_def_ypp,
    def_success_rate = VoA_Variables$def_success_rate,
    ...
    def_havoc_total = VoA_Variables$def_havoc_total,
  ...
  for (p in 1:length(Def_VoA_pars$b0)) {
    for (t in 1:nrow(VoA_Variables)) {
      Def_VoA_Rating <- rnorm(
        1,
        mean = Def_VoA_pars$b0[p] +
          Def_VoA_pars$beta_def_ppa[p] * VoA_Variables$adj_def_ppa[t] +
          Def_VoA_pars$beta_def_ypp[p] * VoA_Variables$adj_def_ypp[t] +
          Def_VoA_pars$beta_def_success_rate[p] *
            VoA_Variables$def_success_rate[t] +
          Def_VoA_pars$beta_def_explosiveness[p] *
          ...
          Def_VoA_pars$beta_def_havoc_total[p] *
            VoA_Variables$def_havoc_total[t] +
  ...
  ST_VoA_datalist <- list(
    ...
    net_kick_return_avg = VoA_Variables$net_kick_return_avg,
    net_punt_return_avg = VoA_Variables$net_punt_return_avg,
    net_fg_rate = VoA_Variables$net_fg_rate,
    net_st_ppa = VoA_Variables$net_adj_st_ppa
  )
  ...
  for (p in 1:length(ST_VoA_pars$b0)) {
    for (t in 1:nrow(VoA_Variables)) {
      ST_VoA_Rating <- rnorm(
        ...
        mean = ST_VoA_pars$b0[p] +
          ST_VoA_pars$beta_net_kick_return_avg[p] *
            VoA_Variables$net_kick_return_avg[t] +
          ST_VoA_pars$beta_net_punt_return_avg[p] *
            VoA_Variables$net_punt_return_avg[t] +
          ST_VoA_pars$beta_net_fg_rate[p] * VoA_Variables$net_fg_rate[t] +
          ST_VoA_pars$beta_net_st_ppa[p] * VoA_Variables$net_adj_st_ppa[t],
        sd = ST_VoA_pars$sigma[p]
      )
      ST_VoA_Ratings[p, t] <- ST_VoA_Rating
    }
...
if (as.numeric(cfb_week) > 11) {
  ...
  completed_games <- cfbd_game_info(as.numeric(year)) |>
    filter(
      home_team %in% VoA_Variables$team | away_team %in% VoA_Variables$team
    ) |>
    select(
      game_id,
      season,
  ...
  for (school in 1:nrow(VoA_Variables)) {
    temp_team <- completed_games |>
      filter(
        home_team == VoA_Variables$team[school] |
          away_team == VoA_Variables$team[school]
      ) |>
      mutate(
        team = VoA_Variables$team[school],
        team_opp = case_when(
          home_team == VoA_Variables$team[school] ~ away_team,
          TRUE ~ home_team
        ),
    ...
    temp_team <- temp_team |>
      mutate(
        actual_diff = case_when(
          home_team == VoA_Variables$team[school] ~ home_points - away_points,
    ...
    temp_team_losses <- temp_team |>
      filter(
        home_team == VoA_Variables$team[school] &
          ...
          away_team == VoA_Variables$team[school] & away_points < home_points
      )
    ## storing overall team Resume Score as vector
    VoA_Variables$Resume_VoA[school] <- sum(temp_team$Resume_Score) -
...
if (as.numeric(cfb_week) == 3) {
  ...
  Full_Ratings_Rks <- read_csv(here(
    "Data",
    paste0("VoA", year),
    "TrackingChartCSVs",
    paste0(year, week_text, "0_", as.numeric(cfb_week) - 1, "Ratings_Rks.csv")
  )) |>
    select(
      team,
      conference,
...
if (as.numeric(cfb_week) >= 3) {
  ...
  AAC_VoA_Rating_Chart <- ggplot(
    AAC_Ratings_Rks,
    aes(x = CFB_Week, y = VoA_Rating_Ovr, group = team)
  ) +
    theme_bw() +
  ...
  AAC_VoA_Ranking_Chart <- ggplot(
    AAC_Ratings_Rks,
    aes(x = CFB_Week, y = VoA_Ranking_Ovr, group = team)
  ) +
    theme_bw() +
    geom_line(linewidth = 1.5) +
    # geom_point(size = 5) +
...
VoA_Variables_plot <- VoA_Variables |>
  mutate(
    team = case_when(team == "App State" ~ "Appalachian State", TRUE ~ team)
  )
...
if (as.numeric(cfb_week) <= 8) {
  VoA_OffDef_EPA_plot <- ggplot(
    VoA_Variables_plot,
    aes(x = weighted_adj_off_ppa, y = weighted_adj_def_ppa)
  ) +
    theme_bw() +
    # geom_point(size = 2) +
    # geom_smooth() +
    scale_y_reverse() +
    geom_cfb_logos(aes(team = team), width = 0.035) +
    geom_hline(yintercept = mean(VoA_Variables$weighted_adj_def_ppa)) +
    geom_vline(xintercept = mean(VoA_Variables$weighted_adj_off_ppa)) +
    # scale_x_continuous(breaks = seq(0,135,10)) +
    # scale_y_continuous(breaks = seq(-50,40,5)) +
  ...
  VoA_OffDef_EPA_plot <- ggplot(
    VoA_Variables_plot,
    aes(x = adj_off_ppa, y = adj_def_ppa)
  ) +
    theme_bw() +
    # geom_point(size = 2) +
    # geom_smooth() +
